...
namespace TaleWorlds.Diamond
{
	...
	public abstract class Client<T> : DiamondClientApplicationObject, IClient where T : Client<T>
	{
		...
		protected Client(DiamondClientApplication diamondClientApplication, IClientSessionProvider<T> sessionProvider, bool autoReconnect) : base(diamondClientApplication)
		{
		...
		{
			this._messageHandlers[message.GetType()].DynamicInvokeWithLog(new object[]
			{
				message
			});
		}
