...
namespace TaleWorlds.Library
{
	...
	public struct ApplicationVersion
	{
		...
		public static ApplicationVersion FromParametersFile(string customParameterFilePath = null)
		{
			...
			return ApplicationVersion.FromString(xmlDocument.ChildNodes[0].ChildNodes[0].Attributes["Value"].InnerText, 45697);
		}
		...
		// Token: 0x0600001B RID: 27 RVA: 0x00002367 File Offset: 0x00000567
		...
		// Token: 0x06000020 RID: 32 RVA: 0x00002513 File Offset: 0x00000713
		public static bool operator !=(ApplicationVersion a, ApplicationVersion b)
		{
			return !(a == b);
		}

		// Token: 0x06000021 RID: 33 RVA: 0x0000251F File Offset: 0x0000071F
		public override int GetHashCode()
		{
			return base.GetHashCode();
		}

		// Token: 0x06000022 RID: 34 RVA: 0x00002531 File Offset: 0x00000731
		...
		// Token: 0x06000024 RID: 36 RVA: 0x000025EE File Offset: 0x000007EE
		public static bool operator <(ApplicationVersion a, ApplicationVersion b)
		{
			return !(a == b) && !(a > b);
		}

		// Token: 0x06000025 RID: 37 RVA: 0x00002605 File Offset: 0x00000805
		public static bool operator >=(ApplicationVersion a, ApplicationVersion b)
		{
			return a == b || a > b;
		}
