...
namespace Newtonsoft.Json.Utilities
{
	...
	internal class DictionaryWrapper<[Nullable(2)] TKey, [Nullable(2)] TValue> : IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IWrappedDictionary, IDictionary, ICollection
	{
		...
		{
			// Token: 0x06000E71 RID: 3697 RVA: 0x0004096F File Offset: 0x0003EB6F
			...
			// (get) Token: 0x06000E72 RID: 3698 RVA: 0x00040983 File Offset: 0x0003EB83
			...
			// (get) Token: 0x06000E73 RID: 3699 RVA: 0x00040990 File Offset: 0x0003EB90
			public object Key
			{
				get
				{
			...
			// (get) Token: 0x06000E74 RID: 3700 RVA: 0x000409AC File Offset: 0x0003EBAC
			public object Value
			{
				get
				{
			...
			// (get) Token: 0x06000E75 RID: 3701 RVA: 0x000409C8 File Offset: 0x0003EBC8
			...
			// Token: 0x06000E76 RID: 3702 RVA: 0x00040A0F File Offset: 0x0003EC0F
			public bool MoveNext()
			{
				return this._e.MoveNext();
			}

			// Token: 0x06000E77 RID: 3703 RVA: 0x00040A1C File Offset: 0x0003EC1C
			public void Reset()
			{
				this._e.Reset();
			}
