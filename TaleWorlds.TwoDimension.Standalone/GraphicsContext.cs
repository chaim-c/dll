	...
	public class GraphicsContext
	{
		...
		public void DrawElements(Material material, DrawObject2D drawObject2D)
		{
			...
			if (material is SimpleMaterial)
			{
				...
				float value = MathF.Clamp(simpleMaterial.HueFactor / 360f, -0.5f, 0.5f);
				float value2 = MathF.Clamp(simpleMaterial.SaturationFactor / 360f, -0.5f, 0.5f);
				float value3 = MathF.Clamp(simpleMaterial.ValueFactor / 360f, -0.5f, 0.5f);
