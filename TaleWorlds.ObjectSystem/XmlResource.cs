...
namespace TaleWorlds.ObjectSystem
{
	...
	{
		// Token: 0x0600008D RID: 141 RVA: 0x00004547 File Offset: 0x00002747
		...
		// Token: 0x0600008E RID: 142 RVA: 0x00004550 File Offset: 0x00002750
			...
			if (mbprojPath.Length > 0 && File.Exists(mbprojPath))
			{
				...
				if (xmlNodeList != null)
				{
					foreach (object obj in xmlNodeList)
					{
						...
						XmlResource.MbprojXmls.Add(item);
					}
				}
			}
		}
