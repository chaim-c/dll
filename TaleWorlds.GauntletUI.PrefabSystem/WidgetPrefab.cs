...
namespace TaleWorlds.GauntletUI.PrefabSystem
{
	...
	public class WidgetPrefab
	{
		...
		// (get) Token: 0x060000CB RID: 203 RVA: 0x00003FC7 File Offset: 0x000021C7
		// (set) Token: 0x060000CC RID: 204 RVA: 0x00003FCF File Offset: 0x000021CF
		public Dictionary<string, VisualDefinitionTemplate> VisualDefinitionTemplates { get; set; }

		// Token: 0x17000032 RID: 50
		// (get) Token: 0x060000CD RID: 205 RVA: 0x00003FD8 File Offset: 0x000021D8
		// (set) Token: 0x060000CE RID: 206 RVA: 0x00003FE0 File Offset: 0x000021E0
		public Dictionary<string, ConstantDefinition> Constants { get; set; }

		// Token: 0x17000033 RID: 51
		// (get) Token: 0x060000CF RID: 207 RVA: 0x00003FE9 File Offset: 0x000021E9
		// (set) Token: 0x060000D0 RID: 208 RVA: 0x00003FF1 File Offset: 0x000021F1
		public Dictionary<string, string> Parameters { get; set; }

		// Token: 0x17000034 RID: 52
		// (get) Token: 0x060000D1 RID: 209 RVA: 0x00003FFA File Offset: 0x000021FA
		// (set) Token: 0x060000D2 RID: 210 RVA: 0x00004002 File Offset: 0x00002202
		public Dictionary<string, XmlElement> CustomElements { get; set; }

		// Token: 0x17000035 RID: 53
		// (get) Token: 0x060000D3 RID: 211 RVA: 0x0000400B File Offset: 0x0000220B
		// (set) Token: 0x060000D4 RID: 212 RVA: 0x00004013 File Offset: 0x00002213
		...
		// Token: 0x060000D6 RID: 214 RVA: 0x00004050 File Offset: 0x00002250
		private static Dictionary<string, VisualDefinitionTemplate> LoadVisualDefinitions(XmlNode visualDefinitionsNode)
		{
			...
			foreach (object obj in visualDefinitionsNode.ChildNodes)
			{
				...
				bool easeIn;
				if (xmlAttribute2 != null && bool.TryParse(xmlAttribute2.Value, out easeIn))
				{
					visualDefinitionTemplate.EaseIn = easeIn;
				}
		...
		// Token: 0x060000D7 RID: 215 RVA: 0x00004264 File Offset: 0x00002464
		...
		// Token: 0x060000D8 RID: 216 RVA: 0x000042B8 File Offset: 0x000024B8
		...
		private static Dictionary<string, XmlElement> LoadCustomElements(XmlNode customElementsNode)
		{
			...
			foreach (object obj in customElementsNode.ChildNodes)
			{
				XmlNode xmlNode = (XmlNode)obj;
				string value = xmlNode.Attributes["Name"].Value;
				XmlElement value2 = xmlNode.FirstChild as XmlElement;
				dictionary.Add(value, value2);
			}
			return dictionary;
		}

		// Token: 0x060000DA RID: 218 RVA: 0x000043CC File Offset: 0x000025CC
		...
		// Token: 0x060000DB RID: 219 RVA: 0x0000445C File Offset: 0x0000265C
		...
		// Token: 0x060000DC RID: 220 RVA: 0x000047B8 File Offset: 0x000029B8
		...
		// Token: 0x060000DD RID: 221 RVA: 0x00004BA8 File Offset: 0x00002DA8
		...
		// Token: 0x060000DE RID: 222 RVA: 0x00004D34 File Offset: 0x00002F34
		...
		// Token: 0x060000DF RID: 223 RVA: 0x00004DDE File Offset: 0x00002FDE
		...
		// Token: 0x060000E0 RID: 224 RVA: 0x00004DF1 File Offset: 0x00002FF1
		...
		// Token: 0x060000E1 RID: 225 RVA: 0x00004E00 File Offset: 0x00003000
		public void OnRelease()
		{
			this.RootTemplate.OnRelease();
		}

		// Token: 0x060000E2 RID: 226 RVA: 0x00004E10 File Offset: 0x00003010
		...
		// Token: 0x060000E3 RID: 227 RVA: 0x00004E30 File Offset: 0x00003030
		public string GetParameterDefaultValue(string name)
		{
			string result;
			this.Parameters.TryGetValue(name, out result);
			return result;
		}
	}
}
