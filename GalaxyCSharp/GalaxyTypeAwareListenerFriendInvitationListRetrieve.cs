...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFriendInvitationListRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFriendInvitationListRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFriendInvitationListRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000526 RID: 1318 RVA: 0x00004368 File Offset: 0x00002568
		public GalaxyTypeAwareListenerFriendInvitationListRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFriendInvitationListRetrieve(), true)
		{
