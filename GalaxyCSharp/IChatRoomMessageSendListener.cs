...
namespace Galaxy.Api
{
	...
	public abstract class IChatRoomMessageSendListener : GalaxyTypeAwareListenerChatRoomMessageSend
	{
		...
		internal IChatRoomMessageSendListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IChatRoomMessageSendListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IChatRoomMessageSendListener() : this(GalaxyInstancePINVOKE.new_IChatRoomMessageSendListener(), true)
		{
