...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFriendAdd : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFriendAdd(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFriendAdd_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000514 RID: 1300 RVA: 0x00003FCC File Offset: 0x000021CC
		public GalaxyTypeAwareListenerFriendAdd() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFriendAdd(), true)
		{
