...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFileShare : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFileShare(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFileShare_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600050E RID: 1294 RVA: 0x00003E98 File Offset: 0x00002098
		public GalaxyTypeAwareListenerFileShare() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFileShare(), true)
		{
