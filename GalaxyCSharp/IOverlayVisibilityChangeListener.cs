...
namespace Galaxy.Api
{
	...
	public abstract class IOverlayVisibilityChangeListener : GalaxyTypeAwareListenerOverlayVisibilityChange
	{
		...
		internal IOverlayVisibilityChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IOverlayVisibilityChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IOverlayVisibilityChangeListener() : this(GalaxyInstancePINVOKE.new_IOverlayVisibilityChangeListener(), true)
		{
