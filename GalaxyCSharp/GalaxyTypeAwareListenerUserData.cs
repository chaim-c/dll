...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerUserData : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerUserData(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerUserData_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000610 RID: 1552 RVA: 0x00007254 File Offset: 0x00005454
		public GalaxyTypeAwareListenerUserData() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerUserData(), true)
		{
