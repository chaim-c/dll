...
namespace Galaxy.Api
{
	...
	public abstract class GlobalGogServicesConnectionStateListener : IGogServicesConnectionStateListener
	{
		...
		internal GlobalGogServicesConnectionStateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalGogServicesConnectionStateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
