...
namespace Galaxy.Api
{
	...
	public abstract class IRichPresenceListener : GalaxyTypeAwareListenerRichPresence
	{
		...
		internal IRichPresenceListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IRichPresenceListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IRichPresenceListener() : this(GalaxyInstancePINVOKE.new_IRichPresenceListener(), true)
		{
