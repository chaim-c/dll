...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerSendInvitation : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerSendInvitation(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerSendInvitation_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005EC RID: 1516 RVA: 0x00006B1C File Offset: 0x00004D1C
		public GalaxyTypeAwareListenerSendInvitation() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerSendInvitation(), true)
		{
