...
namespace Galaxy.Api
{
	...
	public abstract class IFriendAddListener : GalaxyTypeAwareListenerFriendAdd
	{
		...
		internal IFriendAddListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFriendAddListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFriendAddListener() : this(GalaxyInstancePINVOKE.new_IFriendAddListener(), true)
		{
