...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyLeftListener : GalaxyTypeAwareListenerLobbyLeft
	{
		...
		internal ILobbyLeftListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyLeftListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyLeftListener() : this(GalaxyInstancePINVOKE.new_ILobbyLeftListener(), true)
		{
