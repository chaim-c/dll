...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLeaderboardScoreUpdate : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLeaderboardScoreUpdate(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLeaderboardScoreUpdate_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600055C RID: 1372 RVA: 0x00004E3C File Offset: 0x0000303C
		public GalaxyTypeAwareListenerLeaderboardScoreUpdate() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLeaderboardScoreUpdate(), true)
		{
