...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyOwnerChangeListener : GalaxyTypeAwareListenerLobbyOwnerChange
	{
		...
		internal ILobbyOwnerChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyOwnerChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyOwnerChangeListener() : this(GalaxyInstancePINVOKE.new_ILobbyOwnerChangeListener(), true)
		{
