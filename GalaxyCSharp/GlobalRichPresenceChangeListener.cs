...
namespace Galaxy.Api
{
	...
	public abstract class GlobalRichPresenceChangeListener : IRichPresenceChangeListener
	{
		...
		internal GlobalRichPresenceChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalRichPresenceChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
