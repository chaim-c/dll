...
namespace Galaxy.Api
{
	...
	public abstract class GlobalEncryptedAppTicketListener : IEncryptedAppTicketListener
	{
		...
		internal GlobalEncryptedAppTicketListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalEncryptedAppTicketListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
