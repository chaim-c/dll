...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyDataRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyDataRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyDataRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000574 RID: 1396 RVA: 0x0000530C File Offset: 0x0000350C
		public GalaxyTypeAwareListenerLobbyDataRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyDataRetrieve(), true)
		{
