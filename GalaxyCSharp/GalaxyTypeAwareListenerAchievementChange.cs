...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerAchievementChange : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerAchievementChange(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerAchievementChange_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004D2 RID: 1234 RVA: 0x00003290 File Offset: 0x00001490
		public GalaxyTypeAwareListenerAchievementChange() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerAchievementChange(), true)
		{
