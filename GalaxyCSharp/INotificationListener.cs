...
namespace Galaxy.Api
{
	...
	public abstract class INotificationListener : GalaxyTypeAwareListenerNotification
	{
		...
		internal INotificationListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.INotificationListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public INotificationListener() : this(GalaxyInstancePINVOKE.new_INotificationListener(), true)
		{
