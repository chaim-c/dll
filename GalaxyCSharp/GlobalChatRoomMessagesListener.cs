...
namespace Galaxy.Api
{
	...
	public abstract class GlobalChatRoomMessagesListener : IChatRoomMessagesListener
	{
		...
		internal GlobalChatRoomMessagesListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalChatRoomMessagesListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
