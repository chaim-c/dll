...
namespace Galaxy.Api
{
	...
	public abstract class IOtherSessionStartListener : GalaxyTypeAwareListenerOtherSessionStart
	{
		...
		internal IOtherSessionStartListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IOtherSessionStartListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IOtherSessionStartListener() : this(GalaxyInstancePINVOKE.new_IOtherSessionStartListener(), true)
		{
