...
namespace Galaxy.Api
{
	...
	public abstract class GlobalOtherSessionStartListener : IOtherSessionStartListener
	{
		...
		internal GlobalOtherSessionStartListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalOtherSessionStartListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
