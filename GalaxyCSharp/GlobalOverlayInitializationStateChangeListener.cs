...
namespace Galaxy.Api
{
	...
	public abstract class GlobalOverlayInitializationStateChangeListener : IOverlayInitializationStateChangeListener
	{
		...
		internal GlobalOverlayInitializationStateChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalOverlayInitializationStateChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
