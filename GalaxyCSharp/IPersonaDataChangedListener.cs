...
namespace Galaxy.Api
{
	...
	public abstract class IPersonaDataChangedListener : GalaxyTypeAwareListenerPersonaDataChanged
	{
		...
		internal IPersonaDataChangedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IPersonaDataChangedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IPersonaDataChangedListener() : this(GalaxyInstancePINVOKE.new_IPersonaDataChangedListener(), true)
		{
