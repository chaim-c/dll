...
namespace Galaxy.Api
{
	...
	public abstract class IFriendDeleteListener : GalaxyTypeAwareListenerFriendDelete
	{
		...
		internal IFriendDeleteListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFriendDeleteListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFriendDeleteListener() : this(GalaxyInstancePINVOKE.new_IFriendDeleteListener(), true)
		{
