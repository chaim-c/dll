...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerOtherSessionStart : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerOtherSessionStart(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerOtherSessionStart_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005C2 RID: 1474 RVA: 0x000062B0 File Offset: 0x000044B0
		public GalaxyTypeAwareListenerOtherSessionStart() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerOtherSessionStart(), true)
		{
