...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyMemberStateListener : ILobbyMemberStateListener
	{
		...
		internal GameServerGlobalLobbyMemberStateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyMemberStateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
