...
namespace Galaxy.Api
{
	...
	public abstract class ISentFriendInvitationListRetrieveListener : GalaxyTypeAwareListenerSentFriendInvitationListRetrieve
	{
		...
		internal ISentFriendInvitationListRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ISentFriendInvitationListRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ISentFriendInvitationListRetrieveListener() : this(GalaxyInstancePINVOKE.new_ISentFriendInvitationListRetrieveListener(), true)
		{
		...
		{
			typeof(ISentFriendInvitationListRetrieveListener.FailureReason)
		};
