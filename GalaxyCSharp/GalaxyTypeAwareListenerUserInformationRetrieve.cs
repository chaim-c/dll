...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerUserInformationRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerUserInformationRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerUserInformationRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600061C RID: 1564 RVA: 0x000074BC File Offset: 0x000056BC
		public GalaxyTypeAwareListenerUserInformationRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerUserInformationRetrieve(), true)
		{
