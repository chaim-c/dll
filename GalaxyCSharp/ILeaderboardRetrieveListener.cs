...
namespace Galaxy.Api
{
	...
	public abstract class ILeaderboardRetrieveListener : GalaxyTypeAwareListenerLeaderboardRetrieve
	{
		...
		internal ILeaderboardRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILeaderboardRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILeaderboardRetrieveListener() : this(GalaxyInstancePINVOKE.new_ILeaderboardRetrieveListener(), true)
		{
