...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerRichPresenceChange : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerRichPresenceChange(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerRichPresenceChange_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005E0 RID: 1504 RVA: 0x000068B4 File Offset: 0x00004AB4
		public GalaxyTypeAwareListenerRichPresenceChange() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerRichPresenceChange(), true)
		{
