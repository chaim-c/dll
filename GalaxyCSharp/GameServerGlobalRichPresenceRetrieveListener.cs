...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalRichPresenceRetrieveListener : IRichPresenceRetrieveListener
	{
		...
		internal GameServerGlobalRichPresenceRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalRichPresenceRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
