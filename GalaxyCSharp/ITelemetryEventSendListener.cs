...
namespace Galaxy.Api
{
	...
	public abstract class ITelemetryEventSendListener : GalaxyTypeAwareListenerTelemetryEventSend
	{
		...
		internal ITelemetryEventSendListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ITelemetryEventSendListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ITelemetryEventSendListener() : this(GalaxyInstancePINVOKE.new_ITelemetryEventSendListener(), true)
		{
