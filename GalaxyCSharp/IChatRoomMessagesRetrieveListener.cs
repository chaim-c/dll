...
namespace Galaxy.Api
{
	...
	public abstract class IChatRoomMessagesRetrieveListener : GalaxyTypeAwareListenerChatRoomMessagesRetrieve
	{
		...
		internal IChatRoomMessagesRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IChatRoomMessagesRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IChatRoomMessagesRetrieveListener() : this(GalaxyInstancePINVOKE.new_IChatRoomMessagesRetrieveListener(), true)
		{
