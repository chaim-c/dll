...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalTelemetryEventSendListener : ITelemetryEventSendListener
	{
		...
		internal GameServerGlobalTelemetryEventSendListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalTelemetryEventSendListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
