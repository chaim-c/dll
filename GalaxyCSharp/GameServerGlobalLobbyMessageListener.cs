...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyMessageListener : ILobbyMessageListener
	{
		...
		internal GameServerGlobalLobbyMessageListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyMessageListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
