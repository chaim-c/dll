...
namespace Galaxy.Api
{
	...
	public abstract class IAuthListener : GalaxyTypeAwareListenerAuth
	{
		...
		internal IAuthListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IAuthListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IAuthListener() : this(GalaxyInstancePINVOKE.new_IAuthListener(), true)
		{
		...
		{
			typeof(IAuthListener.FailureReason)
		};
