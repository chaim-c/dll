...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerGameInvitationReceived : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerGameInvitationReceived(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerGameInvitationReceived_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600053E RID: 1342 RVA: 0x00004838 File Offset: 0x00002A38
		public GalaxyTypeAwareListenerGameInvitationReceived() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerGameInvitationReceived(), true)
		{
