...
namespace Galaxy.Api
{
	...
	public abstract class IFriendInvitationListener : GalaxyTypeAwareListenerFriendInvitation
	{
		...
		internal IFriendInvitationListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFriendInvitationListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFriendInvitationListener() : this(GalaxyInstancePINVOKE.new_IFriendInvitationListener(), true)
		{
