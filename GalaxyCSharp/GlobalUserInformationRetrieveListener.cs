...
namespace Galaxy.Api
{
	...
	public abstract class GlobalUserInformationRetrieveListener : IUserInformationRetrieveListener
	{
		...
		internal GlobalUserInformationRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalUserInformationRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
