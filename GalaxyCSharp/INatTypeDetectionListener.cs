...
namespace Galaxy.Api
{
	...
	public abstract class INatTypeDetectionListener : GalaxyTypeAwareListenerNatTypeDetection
	{
		...
		internal INatTypeDetectionListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.INatTypeDetectionListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public INatTypeDetectionListener() : this(GalaxyInstancePINVOKE.new_INatTypeDetectionListener(), true)
		{
