...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyDataRetrieveListener : GalaxyTypeAwareListenerLobbyDataRetrieve
	{
		...
		internal ILobbyDataRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyDataRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyDataRetrieveListener() : this(GalaxyInstancePINVOKE.new_ILobbyDataRetrieveListener(), true)
		{
