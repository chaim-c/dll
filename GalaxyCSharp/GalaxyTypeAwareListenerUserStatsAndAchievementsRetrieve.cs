...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerUserStatsAndAchievementsRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerUserStatsAndAchievementsRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerUserStatsAndAchievementsRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000622 RID: 1570 RVA: 0x000075F0 File Offset: 0x000057F0
		public GalaxyTypeAwareListenerUserStatsAndAchievementsRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerUserStatsAndAchievementsRetrieve(), true)
		{
