...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyDataUpdate : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyDataUpdate(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyDataUpdate_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600057A RID: 1402 RVA: 0x00005440 File Offset: 0x00003640
		public GalaxyTypeAwareListenerLobbyDataUpdate() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyDataUpdate(), true)
		{
