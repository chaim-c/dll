...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerNotification : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerNotification(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerNotification_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005B6 RID: 1462 RVA: 0x00006048 File Offset: 0x00004248
		public GalaxyTypeAwareListenerNotification() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerNotification(), true)
		{
