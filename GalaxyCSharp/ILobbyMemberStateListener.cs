...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyMemberStateListener : GalaxyTypeAwareListenerLobbyMemberState
	{
		...
		internal ILobbyMemberStateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyMemberStateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyMemberStateListener() : this(GalaxyInstancePINVOKE.new_ILobbyMemberStateListener(), true)
		{
