...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLeaderboardEntriesRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLeaderboardEntriesRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLeaderboardEntriesRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000550 RID: 1360 RVA: 0x00004BD4 File Offset: 0x00002DD4
		public GalaxyTypeAwareListenerLeaderboardEntriesRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLeaderboardEntriesRetrieve(), true)
		{
