...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLeaderboardRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLeaderboardRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLeaderboardRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000556 RID: 1366 RVA: 0x00004D08 File Offset: 0x00002F08
		public GalaxyTypeAwareListenerLeaderboardRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLeaderboardRetrieve(), true)
		{
