...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLobbyMemberStateListener : ILobbyMemberStateListener
	{
		...
		internal GlobalLobbyMemberStateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLobbyMemberStateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
