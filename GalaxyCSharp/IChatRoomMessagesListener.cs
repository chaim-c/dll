...
namespace Galaxy.Api
{
	...
	public abstract class IChatRoomMessagesListener : GalaxyTypeAwareListenerChatRoomMessages
	{
		...
		internal IChatRoomMessagesListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IChatRoomMessagesListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IChatRoomMessagesListener() : this(GalaxyInstancePINVOKE.new_IChatRoomMessagesListener(), true)
		{
