...
namespace Galaxy.Api
{
	...
	public abstract class IFriendListListener : GalaxyTypeAwareListenerFriendList
	{
		...
		internal IFriendListListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFriendListListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFriendListListener() : this(GalaxyInstancePINVOKE.new_IFriendListListener(), true)
		{
		...
		{
			typeof(IFriendListListener.FailureReason)
		};
