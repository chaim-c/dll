...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerChatRoomWithUserRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerChatRoomWithUserRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerChatRoomWithUserRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004F0 RID: 1264 RVA: 0x00003894 File Offset: 0x00001A94
		public GalaxyTypeAwareListenerChatRoomWithUserRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerChatRoomWithUserRetrieve(), true)
		{
