...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLobbyDataRetrieveListener : ILobbyDataRetrieveListener
	{
		...
		internal GlobalLobbyDataRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLobbyDataRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
