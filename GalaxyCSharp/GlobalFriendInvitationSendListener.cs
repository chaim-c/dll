...
namespace Galaxy.Api
{
	...
	public abstract class GlobalFriendInvitationSendListener : IFriendInvitationSendListener
	{
		...
		internal GlobalFriendInvitationSendListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalFriendInvitationSendListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
