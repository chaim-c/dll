...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalOperationalStateChangeListener : IOperationalStateChangeListener
	{
		...
		internal GameServerGlobalOperationalStateChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalOperationalStateChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
