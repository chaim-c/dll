...
namespace Galaxy.Api
{
	...
	public abstract class IConnectionDataListener : GalaxyTypeAwareListenerConnectionData
	{
		...
		internal IConnectionDataListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IConnectionDataListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IConnectionDataListener() : this(GalaxyInstancePINVOKE.new_IConnectionDataListener(), true)
		{
