...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyMemberDataUpdateListener : GalaxyTypeAwareListenerLobbyMemberDataUpdate
	{
		...
		internal ILobbyMemberDataUpdateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyMemberDataUpdateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyMemberDataUpdateListener() : this(GalaxyInstancePINVOKE.new_ILobbyMemberDataUpdateListener(), true)
		{
