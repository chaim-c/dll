...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalSpecificUserDataListener : ISpecificUserDataListener
	{
		...
		internal GameServerGlobalSpecificUserDataListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalSpecificUserDataListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
