...
namespace Galaxy.Api
{
	...
	public abstract class ILeaderboardsRetrieveListener : GalaxyTypeAwareListenerLeaderboardsRetrieve
	{
		...
		internal ILeaderboardsRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILeaderboardsRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILeaderboardsRetrieveListener() : this(GalaxyInstancePINVOKE.new_ILeaderboardsRetrieveListener(), true)
		{
		...
		{
			typeof(ILeaderboardsRetrieveListener.FailureReason)
		};
