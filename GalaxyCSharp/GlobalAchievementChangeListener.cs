...
namespace Galaxy.Api
{
	...
	public abstract class GlobalAchievementChangeListener : IAchievementChangeListener
	{
		...
		internal GlobalAchievementChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalAchievementChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
