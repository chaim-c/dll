...
namespace Galaxy.Api
{
	...
	public abstract class GlobalTelemetryEventSendListener : ITelemetryEventSendListener
	{
		...
		internal GlobalTelemetryEventSendListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalTelemetryEventSendListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
