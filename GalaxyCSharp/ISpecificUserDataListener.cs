...
namespace Galaxy.Api
{
	...
	public abstract class ISpecificUserDataListener : GalaxyTypeAwareListenerSpecificUserData
	{
		...
		internal ISpecificUserDataListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ISpecificUserDataListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ISpecificUserDataListener() : this(GalaxyInstancePINVOKE.new_ISpecificUserDataListener(), true)
		{
