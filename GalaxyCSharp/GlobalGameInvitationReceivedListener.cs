...
namespace Galaxy.Api
{
	...
	public abstract class GlobalGameInvitationReceivedListener : IGameInvitationReceivedListener
	{
		...
		internal GlobalGameInvitationReceivedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalGameInvitationReceivedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
