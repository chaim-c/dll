...
namespace Galaxy.Api
{
	...
	public abstract class IStatsAndAchievementsStoreListener : GalaxyTypeAwareListenerStatsAndAchievementsStore
	{
		...
		internal IStatsAndAchievementsStoreListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IStatsAndAchievementsStoreListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IStatsAndAchievementsStoreListener() : this(GalaxyInstancePINVOKE.new_IStatsAndAchievementsStoreListener(), true)
		{
		...
		{
			typeof(IStatsAndAchievementsStoreListener.FailureReason)
		};
