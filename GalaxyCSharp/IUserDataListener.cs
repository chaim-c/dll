...
namespace Galaxy.Api
{
	...
	public abstract class IUserDataListener : GalaxyTypeAwareListenerUserData
	{
		...
		internal IUserDataListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IUserDataListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IUserDataListener() : this(GalaxyInstancePINVOKE.new_IUserDataListener(), true)
		{
