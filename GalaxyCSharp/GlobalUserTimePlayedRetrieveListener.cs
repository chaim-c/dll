...
namespace Galaxy.Api
{
	...
	public abstract class GlobalUserTimePlayedRetrieveListener : IUserTimePlayedRetrieveListener
	{
		...
		internal GlobalUserTimePlayedRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalUserTimePlayedRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
