...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerUserFind : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerUserFind(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerUserFind_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000616 RID: 1558 RVA: 0x00007388 File Offset: 0x00005588
		public GalaxyTypeAwareListenerUserFind() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerUserFind(), true)
		{
