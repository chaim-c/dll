...
namespace Galaxy.Api
{
	...
	public abstract class IUserInformationRetrieveListener : GalaxyTypeAwareListenerUserInformationRetrieve
	{
		...
		internal IUserInformationRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IUserInformationRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IUserInformationRetrieveListener() : this(GalaxyInstancePINVOKE.new_IUserInformationRetrieveListener(), true)
		{
