...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalUserInformationRetrieveListener : IUserInformationRetrieveListener
	{
		...
		internal GameServerGlobalUserInformationRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalUserInformationRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
