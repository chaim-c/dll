...
namespace Galaxy.Api
{
	...
	public abstract class IFileShareListener : GalaxyTypeAwareListenerFileShare
	{
		...
		internal IFileShareListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFileShareListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFileShareListener() : this(GalaxyInstancePINVOKE.new_IFileShareListener(), true)
		{
