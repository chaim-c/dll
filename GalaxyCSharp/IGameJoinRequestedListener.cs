...
namespace Galaxy.Api
{
	...
	public abstract class IGameJoinRequestedListener : GalaxyTypeAwareListenerGameJoinRequested
	{
		...
		internal IGameJoinRequestedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IGameJoinRequestedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IGameJoinRequestedListener() : this(GalaxyInstancePINVOKE.new_IGameJoinRequestedListener(), true)
		{
