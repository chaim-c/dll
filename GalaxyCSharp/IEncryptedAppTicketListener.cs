...
namespace Galaxy.Api
{
	...
	public abstract class IEncryptedAppTicketListener : GalaxyTypeAwareListenerEncryptedAppTicket
	{
		...
		internal IEncryptedAppTicketListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IEncryptedAppTicketListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IEncryptedAppTicketListener() : this(GalaxyInstancePINVOKE.new_IEncryptedAppTicketListener(), true)
		{
		...
		{
			typeof(IEncryptedAppTicketListener.FailureReason)
		};
