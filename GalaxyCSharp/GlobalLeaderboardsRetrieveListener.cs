...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLeaderboardsRetrieveListener : ILeaderboardsRetrieveListener
	{
		...
		internal GlobalLeaderboardsRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLeaderboardsRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
