...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerAuth : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerAuth(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerAuth_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004D8 RID: 1240 RVA: 0x000033C4 File Offset: 0x000015C4
		public GalaxyTypeAwareListenerAuth() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerAuth(), true)
		{
