...
namespace Galaxy.Api
{
	...
	public abstract class IConnectionOpenListener : GalaxyTypeAwareListenerConnectionOpen
	{
		...
		internal IConnectionOpenListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IConnectionOpenListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IConnectionOpenListener() : this(GalaxyInstancePINVOKE.new_IConnectionOpenListener(), true)
		{
