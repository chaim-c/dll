...
namespace Galaxy.Api
{
	...
	public abstract class GlobalStatsAndAchievementsStoreListener : IStatsAndAchievementsStoreListener
	{
		...
		internal GlobalStatsAndAchievementsStoreListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalStatsAndAchievementsStoreListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
