...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyDataRetrieveListener : ILobbyDataRetrieveListener
	{
		...
		internal GameServerGlobalLobbyDataRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyDataRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
