...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyMessage : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyMessage(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyMessage_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600059E RID: 1438 RVA: 0x00005B78 File Offset: 0x00003D78
		public GalaxyTypeAwareListenerLobbyMessage() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyMessage(), true)
		{
