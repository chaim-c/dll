...
namespace Galaxy.Api
{
	...
	public class GalaxyID : IDisposable
	{
		...
		public GalaxyID() : this(GalaxyInstancePINVOKE.new_GalaxyID__SWIG_0(), true)
		{
		...
		public GalaxyID(ulong _value) : this(GalaxyInstancePINVOKE.new_GalaxyID__SWIG_1(_value), true)
		{
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
		...
		public GalaxyID(GalaxyID galaxyID) : this(GalaxyInstancePINVOKE.new_GalaxyID__SWIG_2(GalaxyID.getCPtr(galaxyID)), true)
		{
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
