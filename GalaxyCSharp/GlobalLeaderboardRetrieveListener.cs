...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLeaderboardRetrieveListener : ILeaderboardRetrieveListener
	{
		...
		internal GlobalLeaderboardRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLeaderboardRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
