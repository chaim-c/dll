...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerNetworking : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerNetworking(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerNetworking_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005B0 RID: 1456 RVA: 0x00005F14 File Offset: 0x00004114
		public GalaxyTypeAwareListenerNetworking() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerNetworking(), true)
		{
