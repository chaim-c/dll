...
namespace Galaxy.Api
{
	...
	public abstract class IGameInvitationReceivedListener : GalaxyTypeAwareListenerGameInvitationReceived
	{
		...
		internal IGameInvitationReceivedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IGameInvitationReceivedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IGameInvitationReceivedListener() : this(GalaxyInstancePINVOKE.new_IGameInvitationReceivedListener(), true)
		{
