...
namespace Galaxy.Api
{
	...
	public abstract class IChatRoomWithUserRetrieveListener : GalaxyTypeAwareListenerChatRoomWithUserRetrieve
	{
		...
		internal IChatRoomWithUserRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IChatRoomWithUserRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IChatRoomWithUserRetrieveListener() : this(GalaxyInstancePINVOKE.new_IChatRoomWithUserRetrieveListener(), true)
		{
