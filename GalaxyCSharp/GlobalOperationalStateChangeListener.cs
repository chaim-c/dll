...
namespace Galaxy.Api
{
	...
	public abstract class GlobalOperationalStateChangeListener : IOperationalStateChangeListener
	{
		...
		internal GlobalOperationalStateChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalOperationalStateChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
