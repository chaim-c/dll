...
namespace Galaxy.Api
{
	...
	public abstract class ILeaderboardEntriesRetrieveListener : GalaxyTypeAwareListenerLeaderboardEntriesRetrieve
	{
		...
		internal ILeaderboardEntriesRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILeaderboardEntriesRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILeaderboardEntriesRetrieveListener() : this(GalaxyInstancePINVOKE.new_ILeaderboardEntriesRetrieveListener(), true)
		{
