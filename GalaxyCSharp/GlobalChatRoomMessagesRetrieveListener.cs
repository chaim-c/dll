...
namespace Galaxy.Api
{
	...
	public abstract class GlobalChatRoomMessagesRetrieveListener : IChatRoomMessagesRetrieveListener
	{
		...
		internal GlobalChatRoomMessagesRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalChatRoomMessagesRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
