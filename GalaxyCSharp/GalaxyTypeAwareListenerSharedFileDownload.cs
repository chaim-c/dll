...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerSharedFileDownload : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerSharedFileDownload(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerSharedFileDownload_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005F8 RID: 1528 RVA: 0x00006D84 File Offset: 0x00004F84
		public GalaxyTypeAwareListenerSharedFileDownload() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerSharedFileDownload(), true)
		{
