...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFriendList : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFriendList(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFriendList_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000538 RID: 1336 RVA: 0x00004704 File Offset: 0x00002904
		public GalaxyTypeAwareListenerFriendList() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFriendList(), true)
		{
