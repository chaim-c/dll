...
namespace Galaxy.Api
{
	...
	public abstract class IFriendInvitationRespondToListener : GalaxyTypeAwareListenerFriendInvitationRespondTo
	{
		...
		internal IFriendInvitationRespondToListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFriendInvitationRespondToListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFriendInvitationRespondToListener() : this(GalaxyInstancePINVOKE.new_IFriendInvitationRespondToListener(), true)
		{
