...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerUserTimePlayedRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerUserTimePlayedRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerUserTimePlayedRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000628 RID: 1576 RVA: 0x00007724 File Offset: 0x00005924
		public GalaxyTypeAwareListenerUserTimePlayedRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerUserTimePlayedRetrieve(), true)
		{
