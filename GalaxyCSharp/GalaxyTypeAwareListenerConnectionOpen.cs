...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerConnectionOpen : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerConnectionOpen(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerConnectionOpen_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000502 RID: 1282 RVA: 0x00003C30 File Offset: 0x00001E30
		public GalaxyTypeAwareListenerConnectionOpen() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerConnectionOpen(), true)
		{
