...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyEntered : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyEntered(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyEntered_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000580 RID: 1408 RVA: 0x00005574 File Offset: 0x00003774
		public GalaxyTypeAwareListenerLobbyEntered() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyEntered(), true)
		{
