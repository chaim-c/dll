...
namespace Galaxy.Api
{
	...
	public abstract class INetworkingListener : GalaxyTypeAwareListenerNetworking
	{
		...
		internal INetworkingListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.INetworkingListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public INetworkingListener() : this(GalaxyInstancePINVOKE.new_INetworkingListener(), true)
		{
