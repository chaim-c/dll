...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyEnteredListener : ILobbyEnteredListener
	{
		...
		internal GameServerGlobalLobbyEnteredListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyEnteredListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
