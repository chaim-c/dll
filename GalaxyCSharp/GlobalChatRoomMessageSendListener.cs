...
namespace Galaxy.Api
{
	...
	public abstract class GlobalChatRoomMessageSendListener : IChatRoomMessageSendListener
	{
		...
		internal GlobalChatRoomMessageSendListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalChatRoomMessageSendListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
