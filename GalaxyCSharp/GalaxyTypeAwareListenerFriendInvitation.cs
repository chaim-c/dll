...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFriendInvitation : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFriendInvitation(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFriendInvitation_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000520 RID: 1312 RVA: 0x00004234 File Offset: 0x00002434
		public GalaxyTypeAwareListenerFriendInvitation() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFriendInvitation(), true)
		{
