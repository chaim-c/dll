...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerEncryptedAppTicket : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerEncryptedAppTicket(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerEncryptedAppTicket_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000508 RID: 1288 RVA: 0x00003D64 File Offset: 0x00001F64
		public GalaxyTypeAwareListenerEncryptedAppTicket() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerEncryptedAppTicket(), true)
		{
