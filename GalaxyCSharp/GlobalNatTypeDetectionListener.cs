...
namespace Galaxy.Api
{
	...
	public abstract class GlobalNatTypeDetectionListener : INatTypeDetectionListener
	{
		...
		internal GlobalNatTypeDetectionListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalNatTypeDetectionListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
