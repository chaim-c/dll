...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyList : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyList(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyList_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600058C RID: 1420 RVA: 0x000057DC File Offset: 0x000039DC
		public GalaxyTypeAwareListenerLobbyList() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyList(), true)
		{
