...
namespace Galaxy.Api
{
	...
	public class InitParams : IDisposable
	{
		...
		public InitParams(string _clientID, string _clientSecret, string _configFilePath, string _galaxyModulePath, bool _loadModule, string _storagePath) : this(GalaxyInstancePINVOKE.new_InitParams__SWIG_0(_clientID, _clientSecret, _configFilePath, _galaxyModulePath, _loadModule, _storagePath), true)
		{
		...
		public InitParams(string _clientID, string _clientSecret, string _configFilePath, string _galaxyModulePath, bool _loadModule) : this(GalaxyInstancePINVOKE.new_InitParams__SWIG_1(_clientID, _clientSecret, _configFilePath, _galaxyModulePath, _loadModule), true)
		{
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
		...
		public InitParams(string _clientID, string _clientSecret, string _configFilePath, string _galaxyModulePath) : this(GalaxyInstancePINVOKE.new_InitParams__SWIG_2(_clientID, _clientSecret, _configFilePath, _galaxyModulePath), true)
		{
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
		...
		public InitParams(string _clientID, string _clientSecret, string _configFilePath) : this(GalaxyInstancePINVOKE.new_InitParams__SWIG_3(_clientID, _clientSecret, _configFilePath), true)
		{
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
		...
		public InitParams(string _clientID, string _clientSecret) : this(GalaxyInstancePINVOKE.new_InitParams__SWIG_4(_clientID, _clientSecret), true)
		{
			if (GalaxyInstancePINVOKE.SWIGPendingException.Pending)
			{
				throw GalaxyInstancePINVOKE.SWIGPendingException.Retrieve();
