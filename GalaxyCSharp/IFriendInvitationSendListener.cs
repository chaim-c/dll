...
namespace Galaxy.Api
{
	...
	public abstract class IFriendInvitationSendListener : GalaxyTypeAwareListenerFriendInvitationSend
	{
		...
		internal IFriendInvitationSendListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFriendInvitationSendListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFriendInvitationSendListener() : this(GalaxyInstancePINVOKE.new_IFriendInvitationSendListener(), true)
		{
