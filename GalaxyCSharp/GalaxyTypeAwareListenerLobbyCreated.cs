...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyCreated : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyCreated(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyCreated_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000568 RID: 1384 RVA: 0x000050A4 File Offset: 0x000032A4
		public GalaxyTypeAwareListenerLobbyCreated() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyCreated(), true)
		{
