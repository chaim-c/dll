...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyListListener : GalaxyTypeAwareListenerLobbyList
	{
		...
		internal ILobbyListListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyListListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyListListener() : this(GalaxyInstancePINVOKE.new_ILobbyListListener(), true)
		{
