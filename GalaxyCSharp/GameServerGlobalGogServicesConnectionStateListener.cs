...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalGogServicesConnectionStateListener : IGogServicesConnectionStateListener
	{
		...
		internal GameServerGlobalGogServicesConnectionStateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalGogServicesConnectionStateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
