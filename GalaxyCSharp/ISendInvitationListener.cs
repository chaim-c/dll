...
namespace Galaxy.Api
{
	...
	public abstract class ISendInvitationListener : GalaxyTypeAwareListenerSendInvitation
	{
		...
		internal ISendInvitationListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ISendInvitationListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ISendInvitationListener() : this(GalaxyInstancePINVOKE.new_ISendInvitationListener(), true)
		{
