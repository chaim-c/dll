...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerOverlayVisibilityChange : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerOverlayVisibilityChange(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerOverlayVisibilityChange_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005CE RID: 1486 RVA: 0x00006518 File Offset: 0x00004718
		public GalaxyTypeAwareListenerOverlayVisibilityChange() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerOverlayVisibilityChange(), true)
		{
