...
namespace Galaxy.Api
{
	...
	public abstract class IOverlayInitializationStateChangeListener : GalaxyTypeAwareListenerOverlayInitializationStateChange
	{
		...
		internal IOverlayInitializationStateChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IOverlayInitializationStateChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IOverlayInitializationStateChangeListener() : this(GalaxyInstancePINVOKE.new_IOverlayInitializationStateChangeListener(), true)
		{
