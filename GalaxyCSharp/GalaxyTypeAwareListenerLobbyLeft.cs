...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyLeft : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyLeft(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyLeft_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000586 RID: 1414 RVA: 0x000056A8 File Offset: 0x000038A8
		public GalaxyTypeAwareListenerLobbyLeft() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyLeft(), true)
		{
