...
namespace Galaxy.Api
{
	...
	public abstract class ISharedFileDownloadListener : GalaxyTypeAwareListenerSharedFileDownload
	{
		...
		internal ISharedFileDownloadListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ISharedFileDownloadListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ISharedFileDownloadListener() : this(GalaxyInstancePINVOKE.new_ISharedFileDownloadListener(), true)
		{
