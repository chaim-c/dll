...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyMemberDataUpdate : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyMemberDataUpdate(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyMemberDataUpdate_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000592 RID: 1426 RVA: 0x00005910 File Offset: 0x00003B10
		public GalaxyTypeAwareListenerLobbyMemberDataUpdate() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyMemberDataUpdate(), true)
		{
