...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalAccessTokenListener : IAccessTokenListener
	{
		...
		internal GameServerGlobalAccessTokenListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalAccessTokenListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
