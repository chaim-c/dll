...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyLeftListener : ILobbyLeftListener
	{
		...
		internal GameServerGlobalLobbyLeftListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyLeftListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
