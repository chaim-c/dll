...
namespace Galaxy.Api
{
	...
	public abstract class IAccessTokenListener : GalaxyTypeAwareListenerAccessToken
	{
		...
		internal IAccessTokenListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IAccessTokenListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IAccessTokenListener() : this(GalaxyInstancePINVOKE.new_IAccessTokenListener(), true)
		{
