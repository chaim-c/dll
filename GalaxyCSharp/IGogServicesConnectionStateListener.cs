...
namespace Galaxy.Api
{
	...
	public abstract class IGogServicesConnectionStateListener : GalaxyTypeAwareListenerGogServicesConnectionState
	{
		...
		internal IGogServicesConnectionStateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IGogServicesConnectionStateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IGogServicesConnectionStateListener() : this(GalaxyInstancePINVOKE.new_IGogServicesConnectionStateListener(), true)
		{
		...
		{
			typeof(GogServicesConnectionState)
		};
