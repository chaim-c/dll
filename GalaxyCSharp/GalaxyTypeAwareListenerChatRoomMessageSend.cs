...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerChatRoomMessageSend : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerChatRoomMessageSend(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerChatRoomMessageSend_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004E4 RID: 1252 RVA: 0x0000362C File Offset: 0x0000182C
		public GalaxyTypeAwareListenerChatRoomMessageSend() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerChatRoomMessageSend(), true)
		{
