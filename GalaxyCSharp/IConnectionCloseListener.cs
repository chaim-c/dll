...
namespace Galaxy.Api
{
	...
	public abstract class IConnectionCloseListener : GalaxyTypeAwareListenerConnectionClose
	{
		...
		internal IConnectionCloseListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IConnectionCloseListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IConnectionCloseListener() : this(GalaxyInstancePINVOKE.new_IConnectionCloseListener(), true)
		{
