...
namespace Galaxy.Api
{
	...
	public abstract class GlobalGameJoinRequestedListener : IGameJoinRequestedListener
	{
		...
		internal GlobalGameJoinRequestedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalGameJoinRequestedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
