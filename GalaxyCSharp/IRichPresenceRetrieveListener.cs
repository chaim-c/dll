...
namespace Galaxy.Api
{
	...
	public abstract class IRichPresenceRetrieveListener : GalaxyTypeAwareListenerRichPresenceRetrieve
	{
		...
		internal IRichPresenceRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IRichPresenceRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IRichPresenceRetrieveListener() : this(GalaxyInstancePINVOKE.new_IRichPresenceRetrieveListener(), true)
		{
