...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerStatsAndAchievementsStore : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerStatsAndAchievementsStore(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerStatsAndAchievementsStore_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000604 RID: 1540 RVA: 0x00006FEC File Offset: 0x000051EC
		public GalaxyTypeAwareListenerStatsAndAchievementsStore() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerStatsAndAchievementsStore(), true)
		{
