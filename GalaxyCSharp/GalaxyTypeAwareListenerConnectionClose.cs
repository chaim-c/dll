...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerConnectionClose : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerConnectionClose(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerConnectionClose_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004F6 RID: 1270 RVA: 0x000039C8 File Offset: 0x00001BC8
		public GalaxyTypeAwareListenerConnectionClose() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerConnectionClose(), true)
		{
