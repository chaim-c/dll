...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFriendInvitationRespondTo : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFriendInvitationRespondTo(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFriendInvitationRespondTo_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600052C RID: 1324 RVA: 0x0000449C File Offset: 0x0000269C
		public GalaxyTypeAwareListenerFriendInvitationRespondTo() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFriendInvitationRespondTo(), true)
		{
