...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyCreatedListener : GalaxyTypeAwareListenerLobbyCreated
	{
		...
		internal ILobbyCreatedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyCreatedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyCreatedListener() : this(GalaxyInstancePINVOKE.new_ILobbyCreatedListener(), true)
		{
