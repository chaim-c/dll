...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyEnteredListener : GalaxyTypeAwareListenerLobbyEntered
	{
		...
		internal ILobbyEnteredListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyEnteredListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyEnteredListener() : this(GalaxyInstancePINVOKE.new_ILobbyEnteredListener(), true)
		{
