...
namespace Galaxy.Api
{
	...
	public abstract class IFriendInvitationListRetrieveListener : GalaxyTypeAwareListenerFriendInvitationListRetrieve
	{
		...
		internal IFriendInvitationListRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IFriendInvitationListRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IFriendInvitationListRetrieveListener() : this(GalaxyInstancePINVOKE.new_IFriendInvitationListRetrieveListener(), true)
		{
		...
		{
			typeof(IFriendInvitationListRetrieveListener.FailureReason)
		};
