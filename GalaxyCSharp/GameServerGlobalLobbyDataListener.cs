...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyDataListener : ILobbyDataListener
	{
		...
		internal GameServerGlobalLobbyDataListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyDataListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
