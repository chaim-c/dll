...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyDataUpdateListener : ILobbyDataUpdateListener
	{
		...
		internal GameServerGlobalLobbyDataUpdateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyDataUpdateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
