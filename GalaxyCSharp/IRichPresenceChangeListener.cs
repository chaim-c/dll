...
namespace Galaxy.Api
{
	...
	public abstract class IRichPresenceChangeListener : GalaxyTypeAwareListenerRichPresenceChange
	{
		...
		internal IRichPresenceChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IRichPresenceChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IRichPresenceChangeListener() : this(GalaxyInstancePINVOKE.new_IRichPresenceChangeListener(), true)
		{
		...
		{
			typeof(IRichPresenceChangeListener.FailureReason)
		};
