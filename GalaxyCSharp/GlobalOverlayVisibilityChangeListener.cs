...
namespace Galaxy.Api
{
	...
	public abstract class GlobalOverlayVisibilityChangeListener : IOverlayVisibilityChangeListener
	{
		...
		internal GlobalOverlayVisibilityChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalOverlayVisibilityChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
