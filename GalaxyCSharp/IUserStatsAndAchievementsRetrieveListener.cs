...
namespace Galaxy.Api
{
	...
	public abstract class IUserStatsAndAchievementsRetrieveListener : GalaxyTypeAwareListenerUserStatsAndAchievementsRetrieve
	{
		...
		internal IUserStatsAndAchievementsRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IUserStatsAndAchievementsRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IUserStatsAndAchievementsRetrieveListener() : this(GalaxyInstancePINVOKE.new_IUserStatsAndAchievementsRetrieveListener(), true)
		{
