...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyData : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyData(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyData_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600056E RID: 1390 RVA: 0x000051D8 File Offset: 0x000033D8
		public GalaxyTypeAwareListenerLobbyData() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyData(), true)
		{
