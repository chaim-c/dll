...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyMessageListener : GalaxyTypeAwareListenerLobbyMessage
	{
		...
		internal ILobbyMessageListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyMessageListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyMessageListener() : this(GalaxyInstancePINVOKE.new_ILobbyMessageListener(), true)
		{
