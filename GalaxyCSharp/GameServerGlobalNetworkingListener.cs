...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalNetworkingListener : INetworkingListener
	{
		...
		internal GameServerGlobalNetworkingListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalNetworkingListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
