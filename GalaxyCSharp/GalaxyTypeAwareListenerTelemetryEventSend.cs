...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerTelemetryEventSend : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerTelemetryEventSend(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerTelemetryEventSend_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600060A RID: 1546 RVA: 0x00007120 File Offset: 0x00005320
		public GalaxyTypeAwareListenerTelemetryEventSend() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerTelemetryEventSend(), true)
		{
