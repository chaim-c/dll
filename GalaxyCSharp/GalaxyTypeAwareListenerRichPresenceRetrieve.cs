...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerRichPresenceRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerRichPresenceRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerRichPresenceRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005E6 RID: 1510 RVA: 0x000069E8 File Offset: 0x00004BE8
		public GalaxyTypeAwareListenerRichPresenceRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerRichPresenceRetrieve(), true)
		{
