...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerGameJoinRequested : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerGameJoinRequested(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerGameJoinRequested_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000544 RID: 1348 RVA: 0x0000496C File Offset: 0x00002B6C
		public GalaxyTypeAwareListenerGameJoinRequested() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerGameJoinRequested(), true)
		{
