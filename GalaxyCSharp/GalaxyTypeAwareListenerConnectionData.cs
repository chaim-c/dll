...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerConnectionData : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerConnectionData(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerConnectionData_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004FC RID: 1276 RVA: 0x00003AFC File Offset: 0x00001CFC
		public GalaxyTypeAwareListenerConnectionData() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerConnectionData(), true)
		{
