...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFriendDelete : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFriendDelete(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFriendDelete_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x0600051A RID: 1306 RVA: 0x00004100 File Offset: 0x00002300
		public GalaxyTypeAwareListenerFriendDelete() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFriendDelete(), true)
		{
