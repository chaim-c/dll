...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerFriendInvitationSend : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerFriendInvitationSend(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerFriendInvitationSend_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000532 RID: 1330 RVA: 0x000045D0 File Offset: 0x000027D0
		public GalaxyTypeAwareListenerFriendInvitationSend() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerFriendInvitationSend(), true)
		{
