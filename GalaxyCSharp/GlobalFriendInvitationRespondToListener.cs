...
namespace Galaxy.Api
{
	...
	public abstract class GlobalFriendInvitationRespondToListener : IFriendInvitationRespondToListener
	{
		...
		internal GlobalFriendInvitationRespondToListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalFriendInvitationRespondToListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
