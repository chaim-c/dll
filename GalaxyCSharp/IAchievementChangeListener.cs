...
namespace Galaxy.Api
{
	...
	public abstract class IAchievementChangeListener : GalaxyTypeAwareListenerAchievementChange
	{
		...
		internal IAchievementChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IAchievementChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IAchievementChangeListener() : this(GalaxyInstancePINVOKE.new_IAchievementChangeListener(), true)
		{
