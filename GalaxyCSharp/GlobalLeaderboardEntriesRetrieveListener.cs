...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLeaderboardEntriesRetrieveListener : ILeaderboardEntriesRetrieveListener
	{
		...
		internal GlobalLeaderboardEntriesRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLeaderboardEntriesRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
