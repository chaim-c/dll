...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalLobbyCreatedListener : ILobbyCreatedListener
	{
		...
		internal GameServerGlobalLobbyCreatedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalLobbyCreatedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
