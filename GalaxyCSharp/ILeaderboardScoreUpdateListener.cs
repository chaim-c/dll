...
namespace Galaxy.Api
{
	...
	public abstract class ILeaderboardScoreUpdateListener : GalaxyTypeAwareListenerLeaderboardScoreUpdate
	{
		...
		internal ILeaderboardScoreUpdateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILeaderboardScoreUpdateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILeaderboardScoreUpdateListener() : this(GalaxyInstancePINVOKE.new_ILeaderboardScoreUpdateListener(), true)
		{
