...
namespace Galaxy.Api
{
	...
	public abstract class IUserTimePlayedRetrieveListener : GalaxyTypeAwareListenerUserTimePlayedRetrieve
	{
		...
		internal IUserTimePlayedRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IUserTimePlayedRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IUserTimePlayedRetrieveListener() : this(GalaxyInstancePINVOKE.new_IUserTimePlayedRetrieveListener(), true)
		{
