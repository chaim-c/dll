...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerAccessToken : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerAccessToken(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerAccessToken_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004CC RID: 1228 RVA: 0x0000315C File Offset: 0x0000135C
		public GalaxyTypeAwareListenerAccessToken() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerAccessToken(), true)
		{
