...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLeaderboardScoreUpdateListener : ILeaderboardScoreUpdateListener
	{
		...
		internal GlobalLeaderboardScoreUpdateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLeaderboardScoreUpdateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
