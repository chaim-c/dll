...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLeaderboardsRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLeaderboardsRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLeaderboardsRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000562 RID: 1378 RVA: 0x00004F70 File Offset: 0x00003170
		public GalaxyTypeAwareListenerLeaderboardsRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLeaderboardsRetrieve(), true)
		{
