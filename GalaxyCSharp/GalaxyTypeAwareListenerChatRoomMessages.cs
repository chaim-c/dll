...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerChatRoomMessages : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerChatRoomMessages(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerChatRoomMessages_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060004DE RID: 1246 RVA: 0x000034F8 File Offset: 0x000016F8
		public GalaxyTypeAwareListenerChatRoomMessages() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerChatRoomMessages(), true)
		{
