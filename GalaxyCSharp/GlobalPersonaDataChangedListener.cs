...
namespace Galaxy.Api
{
	...
	public abstract class GlobalPersonaDataChangedListener : IPersonaDataChangedListener
	{
		...
		internal GlobalPersonaDataChangedListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalPersonaDataChangedListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
