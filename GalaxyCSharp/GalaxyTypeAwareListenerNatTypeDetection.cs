...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerNatTypeDetection : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerNatTypeDetection(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerNatTypeDetection_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005AA RID: 1450 RVA: 0x00005DE0 File Offset: 0x00003FE0
		public GalaxyTypeAwareListenerNatTypeDetection() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerNatTypeDetection(), true)
		{
