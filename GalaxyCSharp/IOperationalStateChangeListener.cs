...
namespace Galaxy.Api
{
	...
	public abstract class IOperationalStateChangeListener : GalaxyTypeAwareListenerOperationalStateChange
	{
		...
		internal IOperationalStateChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IOperationalStateChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IOperationalStateChangeListener() : this(GalaxyInstancePINVOKE.new_IOperationalStateChangeListener(), true)
		{
