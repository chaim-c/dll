...
namespace Galaxy.Api
{
	...
	public abstract class GlobalSharedFileDownloadListener : ISharedFileDownloadListener
	{
		...
		internal GlobalSharedFileDownloadListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalSharedFileDownloadListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
