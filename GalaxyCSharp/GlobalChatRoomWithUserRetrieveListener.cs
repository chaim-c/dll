...
namespace Galaxy.Api
{
	...
	public abstract class GlobalChatRoomWithUserRetrieveListener : IChatRoomWithUserRetrieveListener
	{
		...
		internal GlobalChatRoomWithUserRetrieveListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalChatRoomWithUserRetrieveListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
