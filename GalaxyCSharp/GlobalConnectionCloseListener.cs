...
namespace Galaxy.Api
{
	...
	public abstract class GlobalConnectionCloseListener : IConnectionCloseListener
	{
		...
		internal GlobalConnectionCloseListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalConnectionCloseListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
