...
namespace Galaxy.Api
{
	...
	public abstract class GameServerGlobalEncryptedAppTicketListener : IEncryptedAppTicketListener
	{
		...
		internal GameServerGlobalEncryptedAppTicketListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GameServerGlobalEncryptedAppTicketListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
