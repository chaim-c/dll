...
namespace Galaxy.Api
{
	...
	public abstract class IUserFindListener : GalaxyTypeAwareListenerUserFind
	{
		...
		internal IUserFindListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.IUserFindListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public IUserFindListener() : this(GalaxyInstancePINVOKE.new_IUserFindListener(), true)
		{
