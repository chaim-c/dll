...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLobbyDataUpdateListener : ILobbyDataUpdateListener
	{
		...
		internal GlobalLobbyDataUpdateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLobbyDataUpdateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
