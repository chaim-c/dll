...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerLobbyMemberState : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerLobbyMemberState(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerLobbyMemberState_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x06000598 RID: 1432 RVA: 0x00005A44 File Offset: 0x00003C44
		public GalaxyTypeAwareListenerLobbyMemberState() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerLobbyMemberState(), true)
		{
