...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerSentFriendInvitationListRetrieve : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerSentFriendInvitationListRetrieve(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerSentFriendInvitationListRetrieve_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005F2 RID: 1522 RVA: 0x00006C50 File Offset: 0x00004E50
		public GalaxyTypeAwareListenerSentFriendInvitationListRetrieve() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerSentFriendInvitationListRetrieve(), true)
		{
