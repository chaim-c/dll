...
namespace Galaxy.Api
{
	...
	public abstract class GlobalFriendInvitationListener : IFriendInvitationListener
	{
		...
		internal GlobalFriendInvitationListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalFriendInvitationListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
