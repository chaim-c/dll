...
namespace Galaxy.Api
{
	...
	public abstract class GalaxyTypeAwareListenerRichPresence : IGalaxyListener
	{
		...
		internal GalaxyTypeAwareListenerRichPresence(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GalaxyTypeAwareListenerRichPresence_SWIGUpcast(cPtr), cMemoryOwn)
		{
			this.swigCPtr = new HandleRef(this, cPtr);
		}

		// Token: 0x060005DA RID: 1498 RVA: 0x00006780 File Offset: 0x00004980
		public GalaxyTypeAwareListenerRichPresence() : this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerRichPresence(), true)
		{
