...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyDataListener : GalaxyTypeAwareListenerLobbyData
	{
		...
		internal ILobbyDataListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyDataListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyDataListener() : this(GalaxyInstancePINVOKE.new_ILobbyDataListener(), true)
		{
