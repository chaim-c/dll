...
namespace Galaxy.Api
{
	...
	public abstract class GlobalLobbyOwnerChangeListener : ILobbyOwnerChangeListener
	{
		...
		internal GlobalLobbyOwnerChangeListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalLobbyOwnerChangeListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
