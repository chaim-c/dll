...
namespace Galaxy.Api
{
	...
	public abstract class ILobbyDataUpdateListener : GalaxyTypeAwareListenerLobbyDataUpdate
	{
		...
		internal ILobbyDataUpdateListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.ILobbyDataUpdateListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
		...
		public ILobbyDataUpdateListener() : this(GalaxyInstancePINVOKE.new_ILobbyDataUpdateListener(), true)
		{
