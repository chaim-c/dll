...
namespace Galaxy.Api
{
	...
	public abstract class GlobalSpecificUserDataListener : ISpecificUserDataListener
	{
		...
		internal GlobalSpecificUserDataListener(IntPtr cPtr, bool cMemoryOwn) : base(GalaxyInstancePINVOKE.GlobalSpecificUserDataListener_SWIGUpcast(cPtr), cMemoryOwn)
		{
