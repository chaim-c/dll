...
namespace TaleWorlds.MountAndBlade.View
{
	...
	public static class ItemObjectViewExtensions
	{
		...
		public static MetaMesh GetMultiMeshCopyWithGenderData(this ItemObject itemObject, bool isFemale, bool hasGloves, bool needBatchedVersion)
		{
			...
			MetaMesh copy = MetaMesh.GetCopy(isFemale ? (itemObject.MultiMeshName + "_female") : (itemObject.MultiMeshName + "_male"), false, true);
			if (copy != null)
			{
				return copy;
			}
			...
			copy = MetaMesh.GetCopy(text, false, true);
			if (copy != null)
			{
				return copy;
			}
			copy = MetaMesh.GetCopy(itemObject.MultiMeshName, true, true);
			if (copy != null)
			{
				return copy;
			}
