...
namespace TaleWorlds.MountAndBlade.View
{
	...
	public static class MountVisualCreator
	{
		...
		public static void SetMaterialProperties(ItemObject mountItem, MetaMesh mountMesh, MountCreationKey key, ref uint maneMeshMultiplier)
		{
			...
			int index = MathF.Min((int)key.MaterialIndex, horseComponent.HorseMaterialNames.Count - 1);
			...
			{
				int num = MathF.Min((int)key.MeshMultiplierIndex, materialProperty.MeshMultiplier.Count - 1);
				if (num != -1)
				{
