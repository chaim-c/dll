...
namespace TaleWorlds.ModuleManager
{
	...
	public class ModuleInfo
	{
		...
		// (get) Token: 0x06000022 RID: 34 RVA: 0x00002621 File Offset: 0x00000821
		// (set) Token: 0x06000023 RID: 35 RVA: 0x00002629 File Offset: 0x00000829
		public bool IsSelected { get; set; }

		// Token: 0x17000006 RID: 6
		// (get) Token: 0x06000024 RID: 36 RVA: 0x00002632 File Offset: 0x00000832
		// (set) Token: 0x06000025 RID: 37 RVA: 0x0000263A File Offset: 0x0000083A
		public string Id { get; private set; }

		// Token: 0x17000007 RID: 7
		// (get) Token: 0x06000026 RID: 38 RVA: 0x00002643 File Offset: 0x00000843
		// (set) Token: 0x06000027 RID: 39 RVA: 0x0000264B File Offset: 0x0000084B
		public string Name { get; private set; }

		// Token: 0x17000008 RID: 8
		// (get) Token: 0x06000028 RID: 40 RVA: 0x00002654 File Offset: 0x00000854
		...
		// (get) Token: 0x06000029 RID: 41 RVA: 0x0000265F File Offset: 0x0000085F
		// (set) Token: 0x0600002A RID: 42 RVA: 0x00002667 File Offset: 0x00000867
		public bool IsDefault { get; private set; }

		// Token: 0x1700000A RID: 10
		// (get) Token: 0x0600002B RID: 43 RVA: 0x00002670 File Offset: 0x00000870
		...
		// (get) Token: 0x0600002C RID: 44 RVA: 0x0000267B File Offset: 0x0000087B
		// (set) Token: 0x0600002D RID: 45 RVA: 0x00002683 File Offset: 0x00000883
		public ApplicationVersion Version { get; private set; }

		// Token: 0x1700000C RID: 12
		// (get) Token: 0x0600002E RID: 46 RVA: 0x0000268C File Offset: 0x0000088C
		...
		// (get) Token: 0x06000032 RID: 50 RVA: 0x000026AE File Offset: 0x000008AE
		// (set) Token: 0x06000033 RID: 51 RVA: 0x000026B6 File Offset: 0x000008B6
		public ModuleType Type { get; private set; }

		// Token: 0x1700000F RID: 15
		// (get) Token: 0x06000034 RID: 52 RVA: 0x000026BF File Offset: 0x000008BF
		...
		// (get) Token: 0x06000035 RID: 53 RVA: 0x000026D5 File Offset: 0x000008D5
		...
		// Token: 0x06000036 RID: 54 RVA: 0x000026E8 File Offset: 0x000008E8
		public ModuleInfo()
		{
		...
		public void LoadWithFullPath(string fullPath)
		{
			...
			ModuleType type;
			if (xmlNode3 != null && Enum.TryParse<ModuleType>(xmlNode3.Attributes["value"].InnerText, out type))
			{
				this.Type = type;
			}
			...
			if (xmlNode4 != null && Enum.TryParse<ModuleCategory>(xmlNode4.Attributes["value"].InnerText, out category))
			{
				...
				for (int i = 0; i < xmlNodeList.Count; i++)
				{
					...
					if (xmlNodeList[i].Attributes["DependentVersion"] != null)
					{
						...
						catch
						{
							...
							{
								"Couldn't parse dependent version of ",
								innerText,
								" for ",
								this.Id,
					...
					bool flag;
					if (bool.TryParse((xmlAttribute != null) ? xmlAttribute.InnerText : null, out flag))
					{
						isOptional = flag;
					}
					this.DependedModules.Add(new DependedModule(innerText, version, isOptional));
				}
			}
		...
		{
			this.Version = new ApplicationVersion(this.Version.ApplicationVersionType, this.Version.Major, this.Version.Minor, this.Version.Revision, 45697);
		}
