...
namespace TaleWorlds.ModuleManager
{
	...
	public class SubModuleInfo
	{
		...
		// (get) Token: 0x06000039 RID: 57 RVA: 0x00002BA5 File Offset: 0x00000DA5
		// (set) Token: 0x0600003A RID: 58 RVA: 0x00002BAD File Offset: 0x00000DAD
		public string Name { get; private set; }

		// Token: 0x17000012 RID: 18
		// (get) Token: 0x0600003B RID: 59 RVA: 0x00002BB6 File Offset: 0x00000DB6
		// (set) Token: 0x0600003C RID: 60 RVA: 0x00002BBE File Offset: 0x00000DBE
		public string DLLName { get; private set; }

		// Token: 0x17000013 RID: 19
		// (get) Token: 0x0600003D RID: 61 RVA: 0x00002BC7 File Offset: 0x00000DC7
		// (set) Token: 0x0600003E RID: 62 RVA: 0x00002BCF File Offset: 0x00000DCF
		public string DLLPath { get; private set; }

		// Token: 0x17000014 RID: 20
		// (get) Token: 0x0600003F RID: 63 RVA: 0x00002BD8 File Offset: 0x00000DD8
		// (set) Token: 0x06000040 RID: 64 RVA: 0x00002BE0 File Offset: 0x00000DE0
		public bool IsTWCertifiedDLL { get; private set; }

		// Token: 0x17000015 RID: 21
		// (get) Token: 0x06000041 RID: 65 RVA: 0x00002BE9 File Offset: 0x00000DE9
		// (set) Token: 0x06000042 RID: 66 RVA: 0x00002BF1 File Offset: 0x00000DF1
		public bool DLLExists { get; private set; }

		// Token: 0x17000016 RID: 22
		// (get) Token: 0x06000043 RID: 67 RVA: 0x00002BFA File Offset: 0x00000DFA
		// (set) Token: 0x06000044 RID: 68 RVA: 0x00002C02 File Offset: 0x00000E02
		public List<string> Assemblies { get; private set; }

		// Token: 0x17000017 RID: 23
		// (get) Token: 0x06000045 RID: 69 RVA: 0x00002C0B File Offset: 0x00000E0B
		// (set) Token: 0x06000046 RID: 70 RVA: 0x00002C13 File Offset: 0x00000E13
		...
		// Token: 0x06000048 RID: 72 RVA: 0x00002C30 File Offset: 0x00000E30
		...
		// Token: 0x06000049 RID: 73 RVA: 0x00002E38 File Offset: 0x00001038
