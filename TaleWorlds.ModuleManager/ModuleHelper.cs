...
namespace TaleWorlds.ModuleManager
{
	...
	public static class ModuleHelper
	{
		...
		// (get) Token: 0x0600000D RID: 13 RVA: 0x000020E9 File Offset: 0x000002E9
		...
		public static ModuleInfo GetModuleInfo(string moduleId)
		{
			...
			if (ModuleHelper._allFoundModules.ContainsKey(key))
			{
				return ModuleHelper._allFoundModules[key];
			}
			return null;
		}

		// Token: 0x06000010 RID: 16 RVA: 0x00002153 File Offset: 0x00000353
		...
		// Token: 0x06000013 RID: 19 RVA: 0x00002193 File Offset: 0x00000393
		private static IEnumerable<string> GetModulePaths(string directoryPath, int searchDepth)
		{
			...
			if (searchDepth > 0)
			{
				...
				{
					foreach (string text in ModuleHelper.GetModulePaths(directoryPath2, searchDepth - 1).ToList<string>())
					{
						yield return text;
					}
		...
		private static List<ModuleInfo> GetPhysicalModules()
		{
			...
			foreach (string text in ModuleHelper.GetModulePaths(ModuleHelper._pathPrefix, 1).ToArray<string>())
			{
				...
				{
					string lpText = string.Concat(new string[]
					{
						"Module ",
						text,
		...
		public static IEnumerable<ModuleInfo> GetModules()
		{
			...
			return from m in ModuleHelper._allFoundModules
			select m.Value;
		}
		...
		public static string GetMbprojPath(string id)
		{
			...
			if (ModuleHelper._allFoundModules.ContainsKey(key))
			{
				return ModuleHelper._allFoundModules[key].FolderPath + "/ModuleData/project.mbproj";
			}
			return "";
		}

		// Token: 0x06000019 RID: 25 RVA: 0x00002522 File Offset: 0x00000722
		...
		// Token: 0x0600001C RID: 28 RVA: 0x00002566 File Offset: 0x00000766
		public static string GetPath(string id)
		{
			return ModuleHelper.GetModuleFullPath(id) + "SubModule.xml";
		}

		// Token: 0x0600001D RID: 29 RVA: 0x00002578 File Offset: 0x00000778
		...
		// Token: 0x06000020 RID: 32 RVA: 0x000025BF File Offset: 0x000007BF
		public static IEnumerable<ModuleInfo> GetDependentModulesOf(IEnumerable<ModuleInfo> source, ModuleInfo module)
		{
			...
			foreach (ModuleInfo moduleInfo2 in source)
			{
				...
				{
					predicate = (<>9__1 = ((DependedModule m) => m.ModuleId == module.Id));
				}
				if (modulesToLoadAfterThis.Any(predicate))
				{
		...
		public static List<ModuleInfo> GetSortedModules(string[] moduleIDs)
		{
			...
			if ((result = (list as List<ModuleInfo>)) == null)
			{
