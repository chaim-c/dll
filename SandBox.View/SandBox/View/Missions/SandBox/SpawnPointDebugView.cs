...
namespace SandBox.View.Missions.SandBox
{
	...
	{
		// Token: 0x06000110 RID: 272 RVA: 0x0000D020 File Offset: 0x0000B220
		...
		// Token: 0x06000111 RID: 273 RVA: 0x0000D035 File Offset: 0x0000B235
		...
		// Token: 0x06000112 RID: 274 RVA: 0x0000D056 File Offset: 0x0000B256
		...
		// Token: 0x06000113 RID: 275 RVA: 0x0000D07D File Offset: 0x0000B27D
		protected override void OnTick(float dt)
		{
			this.ToolMainFunction();
		}

		// Token: 0x06000114 RID: 276 RVA: 0x0000D085 File Offset: 0x0000B285
		...
		// Token: 0x06000115 RID: 277 RVA: 0x0000D094 File Offset: 0x0000B294
		...
		// Token: 0x06000116 RID: 278 RVA: 0x0000D1BC File Offset: 0x0000B3BC
		...
		// Token: 0x06000117 RID: 279 RVA: 0x0000D244 File Offset: 0x0000B444
		...
		// Token: 0x06000118 RID: 280 RVA: 0x0000D2F0 File Offset: 0x0000B4F0
		...
		// Token: 0x06000119 RID: 281 RVA: 0x0000D4B8 File Offset: 0x0000B6B8
		...
		// Token: 0x0600011A RID: 282 RVA: 0x0000D4D0 File Offset: 0x0000B6D0
		...
		// Token: 0x0600011B RID: 283 RVA: 0x0000D644 File Offset: 0x0000B844
		...
		// Token: 0x0600011C RID: 284 RVA: 0x0000E4F0 File Offset: 0x0000C6F0
					...
					if (spawnPointUnits.Place == SpawnPointUnits.SceneType.All || this._sceneType == spawnPointUnits.Place)
					{
						...
						if (!flag2)
						{
							...
							if (spawnPointUnits.MaxCount < spawnPointUnits.CurrentCount)
							{
								...
								{
									text2,
									"It is placed too much. Placed count(",
									spawnPointUnits.CurrentCount,
									"). Max count(",
									spawnPointUnits.MaxCount,
									"). Level: ",
									text
								});
							}
							else
							{
								...
								{
									text2,
									"It is placed too less. Placed count(",
									spawnPointUnits.CurrentCount,
									"). Min count(",
									spawnPointUnits.MinCount,
									"). Level: ",
									text
								});
							}
		...
		// Token: 0x0600011E RID: 286 RVA: 0x0000EA28 File Offset: 0x0000CC28
		...
		// Token: 0x0600011F RID: 287 RVA: 0x0000EC6C File Offset: 0x0000CE6C
		...
		// Token: 0x06000120 RID: 288 RVA: 0x0000ED7C File Offset: 0x0000CF7C
		...
		// Token: 0x06000121 RID: 289 RVA: 0x0000F090 File Offset: 0x0000D290
		...
		// Token: 0x06000122 RID: 290 RVA: 0x0000F320 File Offset: 0x0000D520
		...
		// Token: 0x06000123 RID: 291 RVA: 0x0000F6D0 File Offset: 0x0000D8D0
		...
		// Token: 0x06000124 RID: 292 RVA: 0x0000F72C File Offset: 0x0000D92C
		...
		// Token: 0x06000125 RID: 293 RVA: 0x0000F8A8 File Offset: 0x0000DAA8
		...
		// Token: 0x06000126 RID: 294 RVA: 0x0000F964 File Offset: 0x0000DB64
		...
		// Token: 0x06000127 RID: 295 RVA: 0x0000F99F File Offset: 0x0000DB9F
		...
		// Token: 0x06000128 RID: 296 RVA: 0x0000F9CC File Offset: 0x0000DBCC
		...
		// Token: 0x06000129 RID: 297 RVA: 0x0000FA58 File Offset: 0x0000DC58
		private void CheckNavigationMeshForParticularEntity(GameEntity gameEntity, SpawnPointDebugView.CategoryId categoryId)
		{
			...
			if (!gameEntity.HasScriptOfType<NavigationMeshDeactivator>() && MBEditor.IsEditModeOn && gameEntity.GetEditModeLevelVisibility() && gameEntity.HasScriptOfType<StandingPoint>())
			{
				...
				if (base.Scene.GetNavigationMeshForPosition(ref origin, out this._particularfaceID, 1.5f))
				{
		...
		// Token: 0x0600012A RID: 298 RVA: 0x0000FBC4 File Offset: 0x0000DDC4
			...
			if (firstScriptOfType != null)
			{
				...
				if (alternatives != null && !alternatives.IsEmpty<AnimationPoint>())
				{
					foreach (AnimationPoint animationPoint in alternatives)
					{
						...
						if ((base.Scene.GetNavigationMeshForPosition(ref origin, out this._particularfaceID, 1.5f) || animationPoint.GameEntity.IsGhostObject()) && this._particularfaceID != this._disabledFaceId)
						{
							flag = true;
		...
		// Token: 0x0600012B RID: 299 RVA: 0x0000FD08 File Offset: 0x0000DF08
		...
		// Token: 0x0600012C RID: 300 RVA: 0x0000FE18 File Offset: 0x0000E018
		...
		// Token: 0x0600012D RID: 301 RVA: 0x0000FED4 File Offset: 0x0000E0D4
		...
		// Token: 0x0600012E RID: 302 RVA: 0x0000FFAC File Offset: 0x0000E1AC
		...
		// Token: 0x0600012F RID: 303 RVA: 0x0001003C File Offset: 0x0000E23C
		...
		// Token: 0x06000130 RID: 304 RVA: 0x000100C8 File Offset: 0x0000E2C8
		...
		// Token: 0x06000131 RID: 305 RVA: 0x00010120 File Offset: 0x0000E320
		...
		// Token: 0x06000132 RID: 306 RVA: 0x000101AC File Offset: 0x0000E3AC
		...
		// Token: 0x06000133 RID: 307 RVA: 0x000101DC File Offset: 0x0000E3DC
		...
		// Token: 0x06000134 RID: 308 RVA: 0x00010234 File Offset: 0x0000E434
		...
		// Token: 0x06000135 RID: 309 RVA: 0x00010246 File Offset: 0x0000E446
		...
		// Token: 0x06000136 RID: 310 RVA: 0x00010268 File Offset: 0x0000E468
		...
		// Token: 0x06000137 RID: 311 RVA: 0x00010274 File Offset: 0x0000E474
		...
		// Token: 0x06000138 RID: 312 RVA: 0x00010281 File Offset: 0x0000E481
		...
		// Token: 0x06000139 RID: 313 RVA: 0x00010291 File Offset: 0x0000E491
		...
		// Token: 0x0600013A RID: 314 RVA: 0x000102A4 File Offset: 0x0000E4A4
		private void ImguiSameLine(float positionX, float spacingWidth)
		{
			Imgui.SameLine(positionX, spacingWidth);
		}

		// Token: 0x0600013B RID: 315 RVA: 0x000102AD File Offset: 0x0000E4AD
		...
		// Token: 0x0600013C RID: 316 RVA: 0x000102C1 File Offset: 0x0000E4C1
		private void OnSameLine()
		{
			Imgui.SameLine(0f, 0f);
		}

		// Token: 0x0600013D RID: 317 RVA: 0x000102D2 File Offset: 0x0000E4D2
		private void Separator()
		{
			Imgui.Separator();
		}

		// Token: 0x0600013E RID: 318 RVA: 0x000102DC File Offset: 0x0000E4DC
		...
		// Token: 0x0600013F RID: 319 RVA: 0x000104D0 File Offset: 0x0000E6D0
		private void WriteNavigationMeshTabTexts()
		{
			...
			{
				"(",
				this._currentInvalidPoints,
				" / ",
				this._totalInvalidPoints,
				" ) are being shown."
			}), !this._separatorNeeded, !this._onSameLineNeeded);
		...
		// Token: 0x06000140 RID: 320 RVA: 0x00010C04 File Offset: 0x0000EE04
		...
		// Token: 0x06000141 RID: 321 RVA: 0x00010C64 File Offset: 0x0000EE64
