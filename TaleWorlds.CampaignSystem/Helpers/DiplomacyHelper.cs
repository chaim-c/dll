...
namespace Helpers
{
	...
	public static class DiplomacyHelper
	{
		...
		// Token: 0x06000011 RID: 17 RVA: 0x00002F0C File Offset: 0x0000110C
		private static bool IsLogInTimeRange(LogEntry entry, CampaignTime time)
		{
			return entry.GameTime.NumTicks >= time.NumTicks;
		}

		// Token: 0x06000012 RID: 18 RVA: 0x00002F34 File Offset: 0x00001134
		...
		// Token: 0x06000013 RID: 19 RVA: 0x00002FB8 File Offset: 0x000011B8
