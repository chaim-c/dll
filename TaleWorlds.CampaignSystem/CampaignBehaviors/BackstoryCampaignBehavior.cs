...
namespace TaleWorlds.CampaignSystem.CampaignBehaviors
{
	...
	{
		// Token: 0x06003405 RID: 13317 RVA: 0x000D88FE File Offset: 0x000D6AFE
		public override void RegisterEvents()
		{
			CampaignEvents.OnNewGameCreatedEvent.AddNonSerializedListener(this, new Action<CampaignGameStarter>(this.OnNewGameCreated));
		}

		// Token: 0x06003406 RID: 13318 RVA: 0x000D8917 File Offset: 0x000D6B17
		public override void SyncData(IDataStore dataStore)
		{
		}

		// Token: 0x06003407 RID: 13319 RVA: 0x000D891C File Offset: 0x000D6B1C
		public void OnNewGameCreated(CampaignGameStarter campaignGameStarter)
		{
			...
			{
				predicate = (<>9__0 = ((Hero x) => x.Clan == nimr.Clan));
			}
			foreach (Hero hero2 in deadOrDisabledHeroes.Where(predicate))
			{
