...
namespace TaleWorlds.CampaignSystem.CampaignBehaviors
{
	...
	{
		// Token: 0x060035CF RID: 13775 RVA: 0x000E9F04 File Offset: 0x000E8104
		...
		// Token: 0x060035D0 RID: 13776 RVA: 0x000E9F74 File Offset: 0x000E8174
		...
		// Token: 0x060035D1 RID: 13777 RVA: 0x000E9FC8 File Offset: 0x000E81C8
		public override void SyncData(IDataStore dataStore)
		{
			dataStore.SyncData<Dictionary<Hero, short>>("_previousEducations", ref this._previousEducations);
		}

		// Token: 0x060035D2 RID: 13778 RVA: 0x000E9FDC File Offset: 0x000E81DC
		...
		// Token: 0x060035D3 RID: 13779 RVA: 0x000EA0DC File Offset: 0x000E82DC
		...
		// Token: 0x060035D4 RID: 13780 RVA: 0x000EA130 File Offset: 0x000E8330
		...
		// Token: 0x060035D5 RID: 13781 RVA: 0x000EA188 File Offset: 0x000E8388
		...
		// Token: 0x060035D6 RID: 13782 RVA: 0x000EA1B4 File Offset: 0x000E83B4
		...
		// Token: 0x060035D7 RID: 13783 RVA: 0x000EA1D1 File Offset: 0x000E83D1
		...
		// Token: 0x060035D8 RID: 13784 RVA: 0x000EA1E8 File Offset: 0x000E83E8
		...
		// Token: 0x060035D9 RID: 13785 RVA: 0x000EA2E0 File Offset: 0x000E84E0
		...
		// Token: 0x060035DA RID: 13786 RVA: 0x000EA314 File Offset: 0x000E8514
		...
		// Token: 0x060035DB RID: 13787 RVA: 0x000EA334 File Offset: 0x000E8534
		...
		// Token: 0x060035DC RID: 13788 RVA: 0x000EA3E0 File Offset: 0x000E85E0
		...
		// Token: 0x060035DD RID: 13789 RVA: 0x000EA41C File Offset: 0x000E861C
		...
		// Token: 0x060035DE RID: 13790 RVA: 0x000EA4C0 File Offset: 0x000E86C0
		...
		// Token: 0x060035DF RID: 13791 RVA: 0x000EA504 File Offset: 0x000E8704
		...
		// Token: 0x060035E5 RID: 13797 RVA: 0x000EA5F4 File Offset: 0x000E87F4
		...
		// Token: 0x060035E6 RID: 13798 RVA: 0x000EA6CC File Offset: 0x000E88CC
		private EducationCampaignBehavior.EducationStage CreateStage2(Hero child)
		{
			...
			for (int i = 0; i < array.Length; i++)
			{
				...
				educationPage.AddOption(new EducationCampaignBehavior.EducationOption(array[i].Item1.Name, dictionary[array[i].Item1], null, null, null, new CharacterAttribute[]
				{
					array[i].Item1
				}, null, childProperties2, default(EducationCampaignBehavior.EducationCharacterProperties)));
			}
			...
			for (int j = 0; j < array2.Length; j++)
			{
				...
				educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(array2[j].Item1.Name, dictionary[array2[j].Item1], null, null, null, new CharacterAttribute[]
				{
					array2[j].Item1
				}, null, childProperties4, default(EducationCampaignBehavior.EducationCharacterProperties)));
			}
		...
		// Token: 0x060035E7 RID: 13799 RVA: 0x000EABBE File Offset: 0x000E8DBE
		...
		// Token: 0x060035E8 RID: 13800 RVA: 0x000EABF0 File Offset: 0x000E8DF0
		private void Stage2Selection(List<SkillObject> skills, EducationCampaignBehavior.EducationPage previousPage, EducationCampaignBehavior.EducationPage currentPage, EducationCampaignBehavior.EducationCharacterProperties[] childProperties, EducationCampaignBehavior.EducationCharacterProperties[] tutorProperties)
		{
			for (int i = 0; i < skills.Count; i++)
			{
				...
				currentPage.AddOption(new EducationCampaignBehavior.EducationOption(textObject, textObject2, null, condition, null, null, new SkillObject[]
				{
					skill
				}, childProperties2, specialCharacterProperties));
				...
				currentPage.AddOption(new EducationCampaignBehavior.EducationOption(textObject3, textObject4, null, condition2, null, null, new SkillObject[]
				{
					alternativeSkill
				}, childProperties2, specialCharacterProperties));
			}
		...
		// Token: 0x060035E9 RID: 13801 RVA: 0x000EADE4 File Offset: 0x000E8FE4
		private void Stage16Selection(ValueTuple<TextObject, TextObject, SkillObject>[] titleDescSkillTuple, EducationCampaignBehavior.EducationPage currentPage, EducationCampaignBehavior.EducationCharacterProperties[] childProperties)
		{
			for (int i = 0; i < titleDescSkillTuple.Length; i++)
			{
				...
				EducationCampaignBehavior.EducationOption option = new EducationCampaignBehavior.EducationOption(new TextObject("{=!}{OUTCOME_TITLE}", null), new TextObject("{=!}{OUTCOME_DESC}", null), null, delegate(EducationCampaignBehavior.EducationOption o, List<EducationCampaignBehavior.EducationOption> previousOptions)
				{
					...
					return flag;
				}, null, null, new SkillObject[]
				{
					skill
				}, childProperties2, default(EducationCampaignBehavior.EducationCharacterProperties));
				currentPage.AddOption(option);
			}
		}

		// Token: 0x060035EA RID: 13802 RVA: 0x000EAEC4 File Offset: 0x000E90C4
		private EducationCampaignBehavior.EducationStage CreateStage5(Hero child)
		{
			...
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_leader"), default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_fierce"), default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_ready_throw", "spear_new_f_1-9m", false), default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_memory"), default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=tMkMi5C7}wins wrestling matches.", null), new TextObject("{=zulqIQQw}Children play rough, and this child is usually the one who winds up on top in any tussle.", null), null, null, null, new CharacterAttribute[]
			{
				DefaultCharacterAttributes.Vigor
			}, new SkillObject[]
			{
				DefaultSkills.TwoHanded
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_athlete"), default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_spoiled"), default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=gkuS35ly}caring for your horses.", null), new TextObject("{=smdvQWvu}{?PLAYER_CHILD}Your{?}This{\\?} child loves animals of all kinds. You know that one day {?CHILD.GENDER}she{?}he{\\?} will be a great rider.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Riding
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_riding_2", "carry_saddle", true), default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=1Ehm6o1d}shooting at targets.", null), new TextObject("{=RkQjllml}Given even a few minutes of free time, {?PLAYER_CHILD}your{?}this{\\?} child will line up targets and shoot them with {?CHILD.GENDER}her{?}his{\\?} home-made bow.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Bow
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_ready_bow", "bow_roman_a", true), default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=25vJYig0}trekking around nearby hills.", null), new TextObject("{=LJsckbyF}{?PLAYER_CHILD}Your{?}This{\\?} child spends hours exploring the edges of the estate, following animal tracks and looking for edible plants.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Scouting
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_roguery", "carry_bostaff_rogue1", false), default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=54PfOh98}making {?CHILD.GENDER}her{?}his{\\?} own toys.", null), new TextObject("{=LfJhIQpb}With a few sticks and a bit of twine, {?CHILD.GENDER}she{?}he{\\?} can make recognizable animals, weapons or dolls.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Crafting
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_artisan", "carry_linen", false), default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=hjR0Jvh1}fighting mock battles.", null), new TextObject("{=hGheavqY}{?PLAYER_CHILD}Your{?}This{\\?} child spends most of {?CHILD.GENDER}her{?}his{\\?} free time fighting imaginary monsters with {?CHILD.GENDER}her{?}his{\\?} wooden toy sword.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.OneHanded
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_play_2", "training_sword", false), default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=wX0uzvRE}playing board games.", null), new TextObject("{=H7NJ0QHQ}You see {?PLAYER_CHILD}your{?}the{\\?} child endlessly re-arranging the pieces, inventing new rules and playing out stories in {?CHILD.GENDER}her{?}his{\\?} head.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
			}, new EducationCampaignBehavior.EducationCharacterProperties("act_childhood_tactician"), default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			{
				new ValueTuple<TextObject, TextObject, CharacterAttribute[]>(new TextObject("{=VdLkZthN}Mathematical Aptitude", null), new TextObject("{=23YF84ib}{?PLAYER_CHILD}Your{?}The{\\?} child quickly solves problems in {?CHILD.GENDER}her{?}his{\\?} head, helping adults with their calculations.", null), new CharacterAttribute[]
				{
					DefaultCharacterAttributes.Intelligence
				}),
				new ValueTuple<TextObject, TextObject, CharacterAttribute[]>(new TextObject("{=6RckjM4S}Presence", null), new TextObject("{=Instmiut}Your child is blessed with a strong and sonorous voice, making {?CHILD.GENDER}her{?}him{\\?} seem older and wiser than {?CHILD.GENDER}her{?}his{\\?} years.", null), new CharacterAttribute[]
				{
					DefaultCharacterAttributes.Social
				}),
				new ValueTuple<TextObject, TextObject, CharacterAttribute[]>(new TextObject("{=D1jGAX41}Courage", null), new TextObject("{=WOriPdox}When trouble comes, {?PLAYER_CHILD}your child{?}{?CHILD.GENDER}she{?}he{\\?}{\\?} faces it head on.", null), new CharacterAttribute[]
				{
					DefaultCharacterAttributes.Vigor
				}),
				new ValueTuple<TextObject, TextObject, CharacterAttribute[]>(new TextObject("{=0D1ty8JA}Coordination", null), new TextObject("{=ZkkHPpT7}Your child excels at any task that requires {?CHILD.GENDER}her{?}him{\\?} to use {?CHILD.GENDER}her{?}his{\\?} hands.", null), new CharacterAttribute[]
				{
					DefaultCharacterAttributes.Control
				}),
				new ValueTuple<TextObject, TextObject, CharacterAttribute[]>(new TextObject("{=JqaKRXNo}Craftiness", null), new TextObject("{=1KWhhurv}Your tutor throws up his hands in the air at {CHILD.NAME}'s ability to lie {?CHILD.GENDER}her{?}his{\\?} way out of trouble, but can't help but admire it a little.", null), new CharacterAttribute[]
				{
					DefaultCharacterAttributes.Cunning
				}),
				new ValueTuple<TextObject, TextObject, CharacterAttribute[]>(new TextObject("{=la8jMuQ8}Energy", null), new TextObject("{=RUjPcZhF}{?PLAYER_CHILD}Your{?}The{\\?} child is rarely even winded after {?CHILD.GENDER}her{?}his{\\?} daily exercises.", null), new CharacterAttribute[]
				{
					DefaultCharacterAttributes.Endurance
				})
			};
		...
		// Token: 0x060035EB RID: 13803 RVA: 0x000EB6C4 File Offset: 0x000E98C4
		private EducationCampaignBehavior.EducationStage CreateStage8(Hero child)
		{
			...
			EducationCampaignBehavior.EducationOption stage_2_page_0_option_masterAtArms = new EducationCampaignBehavior.EducationOption(title2, textObject3, null, null, null, new CharacterAttribute[]
			{
				DefaultCharacterAttributes.Vigor
			}, null, childProperties2, specialCharacterProperties);
			EducationCampaignBehavior.EducationOption stage_2_page_0_option_steward = new EducationCampaignBehavior.EducationOption(title3, textObject4, null, null, null, new CharacterAttribute[]
			{
				DefaultCharacterAttributes.Social
			}, null, childProperties3, specialCharacterProperties2);
			EducationCampaignBehavior.EducationOption stage_2_page_0_option_artisan = new EducationCampaignBehavior.EducationOption(title4, textObject5, null, null, null, new CharacterAttribute[]
			{
				DefaultCharacterAttributes.Endurance
			}, null, childProperties4, specialCharacterProperties3);
			EducationCampaignBehavior.EducationOption stage_2_page_0_option_intelligence = new EducationCampaignBehavior.EducationOption(textObject, textObject8, null, null, null, new CharacterAttribute[]
			{
				DefaultCharacterAttributes.Intelligence
			}, null, childProperties5, specialCharacterProperties4);
			EducationCampaignBehavior.EducationOption stage_2_page_0_option_huntsman = new EducationCampaignBehavior.EducationOption(title5, description2, null, null, null, new CharacterAttribute[]
			{
				DefaultCharacterAttributes.Control
			}, null, childProperties6, specialCharacterProperties5);
			EducationCampaignBehavior.EducationOption stage_2_page_0_option_cunning = new EducationCampaignBehavior.EducationOption(textObject2, textObject9, null, null, null, new CharacterAttribute[]
			{
				DefaultCharacterAttributes.Cunning
			}, null, childProperties7, specialCharacterProperties6);
			...
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Riding.Name, new TextObject("{=K08ed2LS}You asked your master-at-arms to make sure that as a noble, this {?CHILD.GENDER}daughter{?}son{\\?} of the clan knows how to hold {?CHILD.GENDER}herself{?}himself{\\?} properly on the saddle.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Riding
			}, childProperties8, specialCharacterProperties7));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Polearm.Name, new TextObject("{=LE0NCSPP}Every warrior needs to know the basics. Polearms are used by warriors of all classes, from feudal levies and urban militias to elite lancers.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Polearm
			}, childProperties9, specialCharacterProperties8));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.OneHanded.Name, new TextObject("{=PpuRM82X}The sword is the weapon of the noble warrior. It is useful both in the battlefield and in court, where it symbolizes a wearer's willingness to fight to protect {?CHILD.GENDER}her{?}his{\\?} honor.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.OneHanded
			}, childProperties10, specialCharacterProperties9));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Athletics.Name, new TextObject("{=C5UrdSgj}Fast legs and stamina are as vital to a warrior's survival as {?CHILD.GENDER}her{?}his{\\?} strength and skill.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Athletics
			}, childProperties11, specialCharacterProperties10));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.TwoHanded.Name, new TextObject("{=Adah5bay}The most powerful weapons require years of practice and conditioning to use properly. Their wielders need to start early.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.TwoHanded
			}, childProperties12, specialCharacterProperties11));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Bow.Name, new TextObject("{=QakanPLW}It will be years before the child can develop the strength, breathing techniques, and patience needed to wield a powerful bow, but it never hurts to start early.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Bow
			...
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Steward.Name, new TextObject("{=XsQ5rabf}The first thing that a steward must know is to how to count add numbers together. ", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Steward
			}, childProperties14, specialCharacterProperties13));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Trade.Name, new TextObject("{=T0LaDdAs}It is important that the child of the clan learns about the goods and their prices, that kind of understanding will be useful for all {?CHILD.GENDER}her{?}his{\\?} life.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Trade
			}, childProperties15, specialCharacterProperties14));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Charm.Name, new TextObject("{=pHmz4GZN}Everything is easier when people are pleased by your presence. Proper grace and etiquette will be useful even among enemies.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Charm
			}, childProperties16, specialCharacterProperties15));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Riding.Name, new TextObject("{=hB72eE6b}Horses are among your clan's most valuable assets, so you encouraged your steward to take the child along on his frequent inspections of the stables.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Riding
			}, childProperties17, specialCharacterProperties16));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Leadership.Name, new TextObject("{=N1WyvVHY}You instructed the child to pay close attention to how the steward exerts authority.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Leadership
			}, childProperties18, specialCharacterProperties17));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Roguery.Name, new TextObject("{=SA4JbVo2}Your steward acts as magistrate in the lord's absence. {?PLAYER_CHILD}Your{?}The{\\?} child will sit at his side as he rules on land disputes, family feuds, and cases of alleged banditry, giving {?CHILD.GENDER}her{?}him{\\?} a look at the darker side of life in Calradia.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Roguery
			...
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Crafting.Name, new TextObject("{=bx6Jhhui}The artisan should make sure that the child knows the basics of smithing, fletching and pole-turning, and that men who work with their hands take pride in their work.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Crafting
			}, childProperties20, specialCharacterProperties19));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Trade.Name, new TextObject("{=xHstOUBx}You made sure your artisan taught this child to recognize quality work, as well as its worth in denars.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Trade
			}, childProperties21, specialCharacterProperties20));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.OneHanded.Name, new TextObject("{=Ir7BP5bD}The best smiths are those that understand how their tools are used. Your child will be tasked with sparring with the weapons and testing their edges. ", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.OneHanded
			}, childProperties22, specialCharacterProperties21));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Engineering.Name, new TextObject("{=N0eHkPV2}A craftsman makes parts and an engineer fits them together. The best artisans learn to do both.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Engineering
			}, childProperties23, specialCharacterProperties22));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Steward.Name, new TextObject("{=tyzzUNN7}You instructed the artisan to teach your the child the basics of managing a workshop.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Steward
			}, childProperties24, specialCharacterProperties23));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Athletics.Name, new TextObject("{=biqBLGwa}You told the artisan to make sure that {?PLAYER_CHILD}your{?}the{\\?} child works hard, and that {?CHILD.GENDER}she{?}he{\\?} swings the hammer for hours in the blazing heat of the forge. It tempers the soul, you believe.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Athletics
			...
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Medicine.Name, new TextObject("{=5pGCtBhd}You asked that your child be schooled over the next few years in all the treatises that can be found on human body, its ailments, and their treatments.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Medicine
			}, childProperties26, specialCharacterProperties25));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Engineering.Name, new TextObject("{=CtImGA4A}Most tutors teach mathematics from tracing the path of stars in the sky, but you wanted your {?IS_BATTANIA_OR_KHUZAIT}lorekeeper{?}scholar{\\?} to focus on the more practical architectural treatises.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Engineering
			}, childProperties27, specialCharacterProperties26));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Leadership.Name, new TextObject("{=Nn8bmGUX}You make sure that the child would be taught the deeds of the leaders of your people, and memorize the rhetoric they used to inspire their followers.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Leadership
			}, childProperties28, specialCharacterProperties27));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Charm.Name, new TextObject("{=MgPubWOa}The epics are full of men and women who preferred words to the sword, and who could win the friendship of allies and the admiration of enemies.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Charm
			}, childProperties29, specialCharacterProperties28));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Steward.Name, new TextObject("{=c4NPLD0S}Any child of a noble clan needs to know how some kings and emperors accumulated wealth and how others squandered it.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Steward
			}, childProperties30, specialCharacterProperties29));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Tactics.Name, new TextObject("{=3iED3Ca9}To craft a tactic one must first have an idea of what has worked in the past and what has failed, and any commander should know the course and outcome of as many battles as possible.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
			...
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Scouting.Name, new TextObject("{=lbHswWdb}Hunting is all about being aware of your surroundings and tracking your prey. You felt that the same skills would serve a lord well in journeys across the wild.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Scouting
			}, childProperties32, specialCharacterProperties31));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Bow.Name, new TextObject("{=ItS9F61H}You told {CHILD.NAME} that any young noble worth {?CHILD.GENDER}her{?}his{\\?} salt should be able to bring down a deer from fifty paces away, or hit a rabbit on the run.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Bow
			}, childProperties33, specialCharacterProperties32));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Polearm.Name, new TextObject("{=bZlhwK0a}Bows are all very well for small game, but those who pursue bears, boar or wolves bring spears along.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Polearm
			}, childProperties34, specialCharacterProperties33));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Medicine.Name, new TextObject("{=rPP0OSBm}Treating sprained ankles, broken bones and lamed horses are as much a part of a hunting expedition as skinning and gutting your quarry.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Medicine
			}, childProperties35, specialCharacterProperties34));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Athletics.Name, new TextObject("{=EbRDo6Lv}A hunter should be able to endure long treks over rough ground and pursue a wounded quarry until it drops.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Athletics
			}, childProperties36, specialCharacterProperties35));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Tactics.Name, new TextObject("{=b9nvCgYF}A hunter knows how to prepare a trap and how to draw a prey to it, and, when dangerous predators are about, how to avoid becoming the hunted.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
		...
		// Token: 0x060035EC RID: 13804 RVA: 0x000ED494 File Offset: 0x000EB694
		private EducationCampaignBehavior.EducationStage CreateStage11(Hero child)
		{
			...
			{
				DefaultCharacterAttributes.Endurance
			}, null, childProperties3, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			{
				DefaultCharacterAttributes.Control
			}, null, childProperties6, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			{
				DefaultCharacterAttributes.Social
			}, null, childProperties7, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Polearm.Name, new TextObject("{=3lDTSlpU}Even the most skilled swordsman or the strongest axe-wielder is to a lancer as the rabbit is to the eagle.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Polearm
			}, childProperties8, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Tactics.Name, new TextObject("{=2s6cH2kE}Even the finest swordsman can perish if his lord is ignorant of the difference between necessary risks and reckless, unnecessary ones.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
			}, childProperties9, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Steward.Name, new TextObject("{=ePNba38W}Armies win battles, but farms and towns win wars.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Steward
			}, childProperties10, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Engineering.Name, new TextObject("{=bnPgkPv2}Towers, domes and gates are wonders that we must never take for granted.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Engineering
			}, childProperties11, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Leadership.Name, new TextObject("{=jqstr7ZL}Learn to fire men's pride, stoke their anger and dispel their fears, and they will turn from men into lions who will do anything for you.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Leadership
			}, childProperties12, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(DefaultSkills.Trade.Name, new TextObject("{=T3vJp4PG}Whoever grasps how prices work can pluck silver out of thin air.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Trade
			}, childProperties13, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			for (int j = 0; j < stage_3_page_2_options.Length; j++)
			{
				...
				stage_3_page_2.AddOption(new EducationCampaignBehavior.EducationOption(optionTitle, item, null, condition, null, null, new SkillObject[]
				{
					item2
				}, childProperties14, default(EducationCampaignBehavior.EducationCharacterProperties)));
			}
			return educationStage;
		}

		// Token: 0x060035ED RID: 13805 RVA: 0x000EDBBC File Offset: 0x000EBDBC
		private EducationCampaignBehavior.EducationStage CreateStage14(Hero child)
		{
			...
			{
				DefaultSkills.Riding
			}, childProperties3, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			{
				DefaultSkills.Engineering
			}, childProperties4, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			{
				DefaultSkills.Tactics
			}, childProperties5, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			{
				DefaultSkills.Bow
			}, childProperties6, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			{
				DefaultSkills.Charm
			}, childProperties7, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=IMaTTgPJ}defeat {?CHILD.GENDER}her{?}his{\\?} fencing instructor.", null), new TextObject("{=cnbeJh6Y}After many tries {?CHILD.GENDER}she{?}he{\\?} successfully beat {?CHILD.GENDER}her{?}his{\\?} tutor, fair and square, during sparring.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.OneHanded
			}, childProperties8, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=EP0gEG0L}win a race.", null), new TextObject("{=7mbE4z2v}{?CHILD.GENDER}She{?}He{\\?} won a friendly horse racing competition, and was rewarded with a magnificent saddle.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Riding
			}, childProperties9, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=ksXTQXOX}craft a weapon.", null), new TextObject("{=6WUaFzlv}{?PLAYER_CHILD}Your{?}The{\\?} child forged a sword - blade, hilt and pommel. The artisan said that he has never seen such dedication and patience in one so young.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Engineering
			}, childProperties10, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=bX841Jau}learn the arts of healing.", null), new TextObject("{=3hFT34l1}{?PLAYER_CHILD}Your{?}The{\\?} child helps out the local physician, binding and cleaning wounds and, when the master is absent, prescribing remedies.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Medicine
			}, childProperties11, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=ltbU06Fi}become a crack shot.", null), new TextObject("{=7JoiyH1Y}You heard that {CHILD.NAME} could put an arrow through an arm ring from 100 paces away, but you didn't believe it until you saw it.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Bow
			}, childProperties12, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=pHbnAZtt}trade like a veteran merchant.", null), new TextObject("{=oaXAY8bw}{?PLAYER_CHILD}Your{?}The{\\?} child asked to borrow money to trade with a passing caravan. You figure {?CHILD.GENDER}she{?}he{\\?}'d be sharped and learn a lesson, but in fact the {?CHILD.GENDER}girl{?}boy{\\?} secured a very lucrative deal.", null), null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Trade
			}, childProperties13, default(EducationCampaignBehavior.EducationCharacterProperties)));
		...
		// Token: 0x060035EE RID: 13806 RVA: 0x000EE404 File Offset: 0x000EC604
		private EducationCampaignBehavior.EducationStage CreateStage16(Hero child)
		{
			...
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=6LpwsxYP}gets bloodied.", null), textObject2, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.OneHanded
			}, childProperties8, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=hes54oh0}joins in a tournament.", null), textObject3, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Polearm
			}, childProperties9, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=z50GdIa3}learns to inspire the soldiers.", null), textObject4, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Charm
			}, childProperties10, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=MpdPpIEY}leads a patrol.", null), textObject5, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Leadership
			}, childProperties11, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=flCA80Ex}trains really hard.", null), textObject6, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.TwoHanded
			}, childProperties12, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage2.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=UuQDXIFD}hunts down bandits.", null), textObject7, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
			}, childProperties13, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=9NbAzOER}dealing with business partners.", null), textObject8, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Charm
			}, childProperties14, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=QVZMiaV2}helping recover stolen goods.", null), textObject9, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Roguery
			}, childProperties15, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=hfaw7Xx9}helping the artisan.", null), textObject10, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Crafting
			}, childProperties16, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=XYRZIPD8}guiding the caravan.", null), textObject11, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Scouting
			}, childProperties17, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=JX13Wd65}managing the logistics of travel.", null), textObject12, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Steward
			}, childProperties18, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage3.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=rvqVuM5o}supervising the guards.", null), textObject13, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Leadership
			}, childProperties19, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=L1o5mb69}learns to construct siege engines.", null), textObject14, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Engineering
			}, childProperties20, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=74pYaU18}treats injuries.", null), textObject15, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Medicine
			}, childProperties21, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=vsFVlFa4}assists the smiths.", null), textObject16, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Crafting
			}, childProperties22, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=jL8ntljn}procures supplies.", null), textObject17, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Trade
			}, childProperties23, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=I6oqLFXh}focuses on the big picture.", null), textObject18, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
			}, childProperties24, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage4.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=XTmpkNNg}socializes with other engineers.", null), textObject19, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Charm
			}, childProperties25, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=AWuEV99O}unleashes {?CHILD.GENDER}her{?}his{\\?} fighting spirit.", null), textObject20, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Athletics
			}, childProperties26, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=Mk6dZBQa}skirmishes from a distance.", null), textObject21, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Bow
			}, childProperties27, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=Mp7dT2u2}chases and is chased.", null), textObject22, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Riding
			}, childProperties28, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=4pOb934Y}understands how a victory is won.", null), textObject23, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
			}, childProperties29, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=eXLxHSls}leads men into enemy territory.", null), textObject24, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Leadership
			}, childProperties30, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage5.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=1BFk0wAV}defeats an enemy.", null), textObject25, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.OneHanded
			}, childProperties31, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=1LWWvGTT}participate in a pilgrimage.", null), textObject26, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Athletics
			}, childProperties32, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=8alDLq0s}not to be too choosy about travelling companions.", null), textObject27, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Roguery
			}, childProperties33, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=RxqCiO7F}competes in tournaments.", null), textObject28, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Polearm
			}, childProperties34, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=ETfx08db}see as much of the world as {?CHILD.GENDER}she{?}he{\\?} could.", null), textObject29, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Riding
			}, childProperties35, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=RhJdnAQY}enjoy the high life.", null), textObject30, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Charm
			}, childProperties36, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage6.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=dObod6IZ}do some honest work.", null), textObject31, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Crafting
			}, childProperties37, default(EducationCampaignBehavior.EducationCharacterProperties)));
			...
			educationPage7.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=6jgjJ3Ts}help anyone in need.", null), textObject32, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Medicine
			}, childProperties38, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage7.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=FfZpLoVD}dabble in intrigue.", null), textObject33, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Roguery
			}, childProperties39, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage7.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=EzbzOsJo}burnish {?CHILD.GENDER}her{?}his{\\?} social skills.", null), textObject34, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Charm
			}, childProperties40, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage7.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=bdYtcgyB}never back down from a challenge.", null), textObject35, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.OneHanded
			}, childProperties41, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage7.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=hrlBxgzs}enjoy the pleasures of the hunt.", null), textObject36, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Riding
			}, childProperties42, default(EducationCampaignBehavior.EducationCharacterProperties)));
			educationPage7.AddOption(new EducationCampaignBehavior.EducationOption(new TextObject("{=XMaeSoRq}never let down {?CHILD.GENDER}her{?}his{\\?} guard.", null), textObject37, null, null, null, null, new SkillObject[]
			{
				DefaultSkills.Tactics
			}, childProperties43, default(EducationCampaignBehavior.EducationCharacterProperties)));
		...
		// Token: 0x060035EF RID: 13807 RVA: 0x000EFE38 File Offset: 0x000EE038
		...
		{
			// Token: 0x06005749 RID: 22345 RVA: 0x00180908 File Offset: 0x0017EB08
			...
			// Token: 0x0600574A RID: 22346 RVA: 0x00180988 File Offset: 0x0017EB88
			...
			// Token: 0x0600574B RID: 22347 RVA: 0x00180A14 File Offset: 0x0017EC14
			...
			// (Invoke) Token: 0x06005B41 RID: 23361
			...
			// (Invoke) Token: 0x06005B45 RID: 23365
		...
		private class EducationStage
		{
			...
			// (get) Token: 0x0600574C RID: 22348 RVA: 0x00180C02 File Offset: 0x0017EE02
			...
			// Token: 0x0600574D RID: 22349 RVA: 0x00180C0F File Offset: 0x0017EE0F
			...
			// Token: 0x0600574E RID: 22350 RVA: 0x00180C2C File Offset: 0x0017EE2C
			...
			// Token: 0x0600574F RID: 22351 RVA: 0x00180CA4 File Offset: 0x0017EEA4
			...
			// Token: 0x06005750 RID: 22352 RVA: 0x00180E00 File Offset: 0x0017F000
			...
			// Token: 0x06005751 RID: 22353 RVA: 0x00180EC8 File Offset: 0x0017F0C8
			...
			// Token: 0x06005752 RID: 22354 RVA: 0x00180F4C File Offset: 0x0017F14C
			...
			// Token: 0x06005753 RID: 22355 RVA: 0x00180FC4 File Offset: 0x0017F1C4
			...
			// Token: 0x06005754 RID: 22356 RVA: 0x0018109C File Offset: 0x0017F29C
			...
			// Token: 0x06005755 RID: 22357 RVA: 0x0018112C File Offset: 0x0017F32C
			...
			// Token: 0x06005756 RID: 22358 RVA: 0x0018118C File Offset: 0x0017F38C
			...
			// Token: 0x06005757 RID: 22359 RVA: 0x001811D4 File Offset: 0x0017F3D4
			...
			// Token: 0x06005758 RID: 22360 RVA: 0x0018125C File Offset: 0x0017F45C
			...
			// Token: 0x06005759 RID: 22361 RVA: 0x001812B8 File Offset: 0x0017F4B8
			public override string ToString()
			{
				return this.Target.ToString();
			}

			// Token: 0x0600575A RID: 22362 RVA: 0x001812CC File Offset: 0x0017F4CC
			...
			// Token: 0x0600575B RID: 22363 RVA: 0x00181324 File Offset: 0x0017F524
		...
		{
			// Token: 0x0600575C RID: 22364 RVA: 0x0018137B File Offset: 0x0017F57B
			...
			// Token: 0x0600575D RID: 22365 RVA: 0x001813A2 File Offset: 0x0017F5A2
			...
			// Token: 0x0600575E RID: 22366 RVA: 0x001813AF File Offset: 0x0017F5AF
			...
			// Token: 0x0600575F RID: 22367 RVA: 0x001813C0 File Offset: 0x0017F5C0
			...
			// Token: 0x06005760 RID: 22368 RVA: 0x0018140F File Offset: 0x0017F60F
			public static bool operator !=(EducationCampaignBehavior.EducationCharacterProperties a, EducationCampaignBehavior.EducationCharacterProperties b)
			{
				return !(a == b);
			}

			// Token: 0x06005761 RID: 22369 RVA: 0x0018141C File Offset: 0x0017F61C
			...
			// Token: 0x06005762 RID: 22370 RVA: 0x00181475 File Offset: 0x0017F675
			...
			// Token: 0x06005763 RID: 22371 RVA: 0x00181490 File Offset: 0x0017F690
			...
			// Token: 0x06005764 RID: 22372 RVA: 0x001814DE File Offset: 0x0017F6DE
		...
		private class EducationPage
		{
			...
			// (get) Token: 0x06005766 RID: 22374 RVA: 0x0018152F File Offset: 0x0017F72F
			...
			// Token: 0x06005767 RID: 22375 RVA: 0x0018153C File Offset: 0x0017F73C
			...
			// Token: 0x06005768 RID: 22376 RVA: 0x00181596 File Offset: 0x0017F796
			...
			// Token: 0x06005769 RID: 22377 RVA: 0x001815D0 File Offset: 0x0017F7D0
			public EducationCampaignBehavior.EducationOption GetOption(string optionKey)
			{
			...
			// Token: 0x0600576A RID: 22378 RVA: 0x001815F0 File Offset: 0x0017F7F0
			...
			// (Invoke) Token: 0x06005B49 RID: 23369
