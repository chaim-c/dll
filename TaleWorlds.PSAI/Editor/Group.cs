...
namespace psai.Editor
{
	...
	public class Group : PsaiMusicEntity, ICloneable
	{
		...
		public Group(Theme parentTheme, string name) : this()
		{
		...
		public Group(Theme parentTheme) : this()
		{
			this.Theme = parentTheme;
		}
		...
		public override object Clone()
		{
			...
			group.ManuallyBlockedGroups = new HashSet<Group>();
			group.ManuallyLinkedGroups = new HashSet<Group>();
			foreach (Group item in this.ManuallyBlockedGroups)
			{
				group.ManuallyBlockedGroups.Add(item);
			}
			foreach (Group item2 in this.ManuallyLinkedGroups)
			{
				group.ManuallyLinkedGroups.Add(item2);
			}
			return group;
		}
