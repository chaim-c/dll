...
namespace psai.net
{
	...
	public class AudioPlaybackLayerChannelStandalone : IAudioPlaybackLayerChannel
	{
		...
		public PsaiResult LoadSegment(Segment segment)
		{
			...
			string pathToClip = Path.Combine(Logik.Instance.m_psaiCoreSoundtrackDirectoryName, this._audioData.filePathRelativeToProjectDir);
			Music.LoadClip(this.index, pathToClip);
